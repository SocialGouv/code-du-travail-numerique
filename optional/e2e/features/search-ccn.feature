...
Scénario:
  ...
  Quand je renseigne "boulangerie" dans le champ "Renseignez le nom de votre convention collective, le nom de votre entreprise, son SIRET ou son SIREN."
  ...
  Quand je renseigne "2247" dans le champ "Renseignez le nom de votre convention collective, le nom de votre entreprise, son SIRET ou son SIREN."
  Quand j'attend que le texte "CONVENTIONS COLLECTIVES" apparaisse
  ...
  Quand je scroll à "Renseignez le nom de votre convention collective"
  Quand je renseigne "corso balard" dans le champ "Renseignez le nom de votre convention collective, le nom de votre entreprise, son SIRET ou son SIREN."
