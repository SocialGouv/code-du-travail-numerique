...
`,We=N(k)`
  ...
  border: ${({theme:e})=>$.border(e.border)};
  ...
  @media (max-width: ${x.tablet}) {
    margin: ${y.tiny};
    border-bottom: ${({theme:e})=>$.border(e.border)};
...
//# sourceMappingURL=story-f76973aa.js.map
