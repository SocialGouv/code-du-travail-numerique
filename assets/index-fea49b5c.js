import{j as s,s as y,A as f}from"./styled-components.browser.esm-41178855.js";import{P as e}from"./index-1fc0ca9a.js";import{S as h}from"./index-557d8fd6.js";import{f as l,s as n,a as m}from"./theme-2d6880ff.js";import{H as v,T as x}from"./TitleParagraph-71649034.js";const o=({as:i,children:a,isFirst:u,shift:r="",subtitle:d,stripe:t,variant:p,isHeader:c,...g})=>s.jsxs(v,{as:c?"header":"div",isFirst:u,stripe:t,shift:r,...g,children:[s.jsxs(b,{stripe:t,as:i,shift:r,children:[t!=="none"&&s.jsx(h,{rounded:p!=="primary",variant:p,...t==="left"&&{length:"100%",position:"left"}}),a]}),d&&s.jsx(x,{stripe:t,shift:r,children:d})]});o.propTypes={as:e.string,children:e.node,id:e.string,isFirst:e.bool,isHeader:e.bool,role:e.string,shift:e.string,stripe:e.oneOf(["left","top","none"]),subtitle:e.node,variant:e.string};o.defaultProps={isFirst:!1,isHeader:!1,stripe:"left",variant:"secondary"};const b=y.h2`
  position: relative;
  margin: 0;
...
//# sourceMappingURL=index-fea49b5c.js.map
