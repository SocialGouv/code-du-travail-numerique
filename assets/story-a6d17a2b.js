import{j as e,s as f}from"./styled-components.browser.esm-525a869c.js";import{B as b}from"./index-d4731c88.js";import{S as u}from"./index-feda07e2.js";import{T as p}from"./index-74cd448a.js";import{P as s}from"./index-8d47fad6.js";import{R as y,r as x}from"./index-76fb7be0.js";import{F as $}from"./index-5e99cee0.js";import{a as j,s as S}from"./theme-664d9dda.js";import"./_commonjsHelpers-de833af9.js";import"./polished.esm-ee8b58af.js";import"./ShareWhatsapp-32297fb2.js";import"./index-2b14ce32.js";import"./TitleParagraph-92e7f26a.js";const r=({button:n,children:t,initialSize:a,tolerance:o,listContainer:C,query:g,stepSize:h})=>{const i=y.Children.count(t),[d,c]=x.useState(i);x.useEffect(()=>{const l=o?a+o:a*1.2+1;c(l>=i?i:a)},[i,a,o,g]);const k=x.useCallback(()=>{if(!h)return c(i);const l=d+h;return(o?l+o:l*1.2+1)>=i?c(i):c(l)},[h,o,d,i]),w=i>d;return e.jsxs(e.Fragment,{children:[e.jsx(C,{children:y.Children.toArray(t).slice(0,d)}),w&&e.jsx(z,{children:n(k)})]})};r.propTypes={button:s.func,children:s.node.isRequired,initialSize:s.number,listContainer:s.elementType,query:s.string,stepSize:s.number,tolerance:s.number};const q=n=>e.jsx(V,{type:"button",onClick:n,children:"Voir plus"});r.defaultProps={button:q,initialSize:7,listContainer:$,query:""};const z=f.div`
  display: flex;
...
//# sourceMappingURL=story-a6d17a2b.js.map
