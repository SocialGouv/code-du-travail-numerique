import{s as l,A as n}from"./styled-components.browser.esm-41178855.js";import{b as t}from"./theme-2d6880ff.js";const r=l.span`
  position: absolute;
  background-color: ${({variant:e,theme:a})=>a[e??"secondary"]};
  border-radius: ${({rounded:e})=>e?t.borderRadius:"0"};
  ${({position:e="top",length:a})=>n`
      top: ${e==="top"?"0":"50%"};
      left: ${e==="left"?"0":"50%"};
...
//# sourceMappingURL=index-559740d3.js.map
