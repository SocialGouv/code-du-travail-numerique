import{s,j as o,A as m}from"./styled-components.browser.esm-beddb3d4.js";import{A as O,d as _,c as z,b as A,a as F}from"./index-78bf1ccb.js";import{P as n}from"./index-8d47fad6.js";import{H as Z}from"./index-8a5570c0.js";import{f as M}from"./keyframes-dddb9d72.js";import{c as V,b as p,s as i,a as d,f as u}from"./theme-6bad1081.js";import{r as J,R as E}from"./index-76fb7be0.js";function v(){return v=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(e[a]=r[a])}return e},v.apply(this,arguments)}function Q(e,t){if(e==null)return{};var r=Y(e,t),a,l;if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(e);for(l=0;l<c.length;l++)a=c[l],!(t.indexOf(a)>=0)&&Object.prototype.propertyIsEnumerable.call(e,a)&&(r[a]=e[a])}return r}function Y(e,t){if(e==null)return{};var r={},a=Object.keys(e),l,c;for(c=0;c<a.length;c++)l=a[c],!(t.indexOf(l)>=0)&&(r[l]=e[l]);return r}var q=J.forwardRef(function(e,t){var r=e.color,a=r===void 0?"currentColor":r,l=e.size,c=l===void 0?24:l,y=Q(e,["color","size"]);return E.createElement("svg",v({ref:t,xmlns:"http://www.w3.org/2000/svg",width:c,height:c,viewBox:"0 0 24 24",fill:"none",stroke:a,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},y),E.createElement("polyline",{points:"9 18 15 12 9 6"}))});q.propTypes={color:n.string,size:n.oneOfType([n.string,n.number])};q.displayName="ChevronRight";const K=q,D=s(K)`
  position: relative;
  flex: 0 0 auto;
...
`;B.__docgenInfo={description:"",methods:[],displayName:"ItemButton",props:{children:{type:{name:"node"},required:!0,description:""},icon:{type:{name:"elementType"},required:!1,description:""}}};const Oe=Object.freeze(Object.defineProperty({__proto__:null,Accordion:ge,Item:ye,ItemButton:B,ItemPanel:xe},Symbol.toStringTag,{value:"Module"})),b=Object.freeze(Object.defineProperty({__proto__:null,base:ie,hierarchy:be,tile:Oe},Symbol.toStringTag,{value:"Module"})),C=({items:e,disableStyles:t,variant:r,titleLevel:a,...l})=>{const c=b[r].Accordion,y=b[r].Item,H=b[r].ItemButton,N=b[r].ItemPanel;return o.jsx(c,{allowZeroExpanded:!0,allowMultipleExpanded:!0,...l,children:e.map(({body:G,icon:X,id:x,title:L},$)=>o.jsx("div",{id:x,children:o.jsxs(y,{index:$,uuid:x,isLast:$===e.length-1,children:[o.jsx(F,{children:o.jsx(H,{icon:X,index:$,isLast:$===e.length-1,disableStyles:t,children:a&&a<=6?o.jsx(Z,{as:"h"+a,stripe:"none",style:{margin:0},dataTestid:`${l["data-testid"]}-${$}`,children:L}):o.jsx("p",{children:L})})}),o.jsx(N,{children:o.jsx(_e,{children:G})})]})},`${x}-${$}`))})};C.propTypes={"data-testid":n.string,disableStyles:n.bool,items:n.arrayOf(n.shape({body:n.node.isRequired,icon:n.elementType,id:n.string,title:n.string.isRequired})).isRequired,preExpanded:n.arrayOf(n.string),titleLevel:n.number.isRequired,variant:n.oneOf(["base","tile","hierarchy"])};C.defaultProps={preExpanded:[],variant:"base"};const _e=s.div`
...
//# sourceMappingURL=index-2a0f9c1e.js.map
