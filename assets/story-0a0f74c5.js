import{s as r,j as i,A as Y}from"./styled-components.browser.esm-beddb3d4.js";import{A as J,S as K,E as Q}from"./ShareWhatsapp-5fd28490.js";import{S as a}from"./index-19caadc8.js";import{P as t}from"./index-8d47fad6.js";import{b as x,s as o,a as v,f as R,c as X}from"./theme-6bad1081.js";import{R as E,r as T}from"./index-76fb7be0.js";import{S as Z}from"./index-c4009f5c.js";import{T as ee}from"./index-da8f0e66.js";import"./_commonjsHelpers-de833af9.js";import"./polished.esm-3b4f0385.js";const $=({label:e,name:n,id:s,size:c,checked:y,...m})=>i.jsxs(ie,{htmlFor:s,size:c,children:[i.jsx(te,{type:"checkbox",name:n,id:s,size:c,checked:y,...m}),e]});$.propTypes={checked:t.bool,id:t.string.isRequired,label:t.oneOfType([t.string,t.node]).isRequired,name:t.string.isRequired,size:t.string};$.defaultProps={size:"1.6rem"};const ie=r.label`
  display: flex;
  font-size: ${e=>e.size};
  cursor: pointer;
  user-select: none;
...
`;$.__docgenInfo={description:"",methods:[],displayName:"InputCheckbox",props:{size:{defaultValue:{value:'"1.6rem"',computed:!1},type:{name:"string"},required:!1,description:""},checked:{type:{name:"bool"},required:!1,description:""},id:{type:{name:"string"},required:!0,description:""},label:{type:{name:"union",value:[{name:"string"},{name:"node"}]},required:!0,description:""},name:{type:{name:"string"},required:!0,description:""}}};const C=({children:e,...n})=>i.jsxs(ne,{...n,children:[" ",e]});C.propTypes={children:t.node.isRequired};const ne=r.fieldset`
  ...
  margin: 0;
  padding: 0;
`;C.__docgenInfo={description:"",methods:[],displayName:"Fieldset",props:{children:{type:{name:"node"},required:!0,description:""}}};const b=({icon:e,text:n,className:s,updateOnScrollDisabled:c,ref:y,...m})=>{const j=c?{onWheel:_=>_.target.blur()}:{};return i.jsxs(re,{className:s,children:[i.jsx(se,{hasIcon:!!e,text:n,...j,...m,ref:y}),e&&i.jsx(P,{text:n,children:i.jsx(e,{})}),n&&i.jsx(P,{text:n,children:i.jsx("span",{children:n})})]})},L={className:t.string,icon:t.elementType,id:t.string,invalid:t.bool,name:t.string.isRequired,onBlur:t.func,onChange:t.func,placeholder:t.string,ref:t.any,text:t.string,title:t.string,type:t.string,updateOnScrollDisabled:t.bool,value:t.any};b.propTypes=L;b.defaultProps={icon:null};const B="5.4rem",re=r.div`
  position: relative;
...
`,P=r.div`
  ...
  ${({text:e})=>e&&Y`
      ...
      user-select: none;
    `};
`;b.__docgenInfo={description:"",methods:[],displayName:"Input",props:{icon:{defaultValue:{value:"null",computed:!1},type:{name:"elementType"},required:!1,description:""},className:{type:{name:"string"},required:!1,description:""},id:{type:{name:"string"},required:!1,description:""},invalid:{type:{name:"bool"},required:!1,description:""},name:{type:{name:"string"},required:!0,description:""},onBlur:{type:{name:"func"},required:!1,description:""},onChange:{type:{name:"func"},required:!1,description:""},placeholder:{type:{name:"string"},required:!1,description:""},ref:{type:{name:"any"},required:!1,description:""},text:{type:{name:"string"},required:!1,description:""},title:{type:{name:"string"},required:!1,description:""},type:{type:{name:"string"},required:!1,description:""},updateOnScrollDisabled:{type:{name:"bool"},required:!1,description:""},value:{type:{name:"any"},required:!1,description:""}}};function A(e){return(e.length===2||e.length===5)&&(e+="/"),e}const H=({value:e,onChange:n,invalid:s,ref:c,...y})=>{const[m,j]=E.useState(e??""),[_,q]=E.useState(!0),[D,k]=E.useState(!1),V=l=>{const p=l.target.selectionStart,h=l.target.selectionEnd,f=l.target.value;if(l.nativeEvent.inputType==="deleteContentBackward"){j(f);return}const S=f.replace(/\D/g,"");if(S.length<=8){let u="";for(let N=0;N<S.length;N++)u=A(u),u+=S[N];u=A(u),j(u),q(M(u)),n&&n(u),setTimeout(()=>{h<u.length-1&&l.target.setSelectionRange(p,h)},0)}},I=l=>{const p=l.target.value;if(p&&p!==""){const h=p.split("-"),f=h[0]??"",z=h[1]??"",u=`${h[2]??""}/${z}/${f}`;j(u),q(!0),n&&n(u)}},W=()=>{const l=m.split("/"),p=l[0]??"",h=l[1]??"",f=l[2]??"";return f.length===2?`20${f}-${h}-${p}`:`${f}-${h}-${p}`},M=l=>{if(l&&l.length===10){const p=l.split("/"),h=isNaN(Number(p[0]))?null:Number(p[0]),f=isNaN(Number(p[1]))?null:Number(p[1]),z=isNaN(Number(p[2]))?null:Number(p[2]),S=z&&z>=1900&&z<=2100,u=f&&f>=1&&f<=12,N=h&&h>=1&&h<=31,G=/^\d{2}\/\d{2}\/\d{4}$/.test(l);return S&&u&&N&&G}return!0},U=()=>{k(!1),m.length!==10&&q(!1)};return i.jsxs(oe,{isFocus:D,isValid:s===!0?!1:s===!1?!0:_,children:[i.jsx(ae,{value:m,onChange:V,placeholder:"jj/mm/aaaa",onFocus:()=>k(!0),onBlur:U,...y,ref:c}),i.jsxs(de,{children:[i.jsx(ce,{children:i.jsx(pe,{width:"100%",height:"100%"})}),i.jsx(le,{type:"date","aria-disabled":!_,tabIndex:-1,min:"1900-01-01",max:"2100-01-01",maxlength:"11",value:W(),onChange:I})]})]})};H.propTypes=L;const oe=r.div`
  display: flex;
  flex-direction: row;
...
`;F.__docgenInfo={description:"",methods:[],displayName:"Legend",props:{isHidden:{defaultValue:{value:"false",computed:!1},type:{name:"bool"},required:!1,description:""},children:{type:{name:"node"},required:!0,description:""}}};const g=({label:e,name:n,id:s,size:c,onChange:y,className:m,...j})=>i.jsxs(fe,{className:m,children:[i.jsx(xe,{type:"radio",name:n,id:s,size:c,onChange:y,...j}),i.jsx(me,{htmlFor:s,size:c,children:e})]});g.propTypes={checked:t.bool,className:t.string,id:t.string.isRequired,label:t.oneOfType([t.string,t.node]).isRequired,name:t.string.isRequired,onChange:t.func,size:t.string.isRequired,value:t.string};g.defaultProps={size:"1.6rem"};const me=r.label`
  display: flex;
  font-size: ${({size:e})=>e};
  cursor: pointer;
`,fe=r.div`
...
`;g.__docgenInfo={description:"",methods:[],displayName:"InputRadio",props:{size:{defaultValue:{value:'"1.6rem"',computed:!1},type:{name:"string"},required:!1,description:""},checked:{type:{name:"bool"},required:!1,description:""},className:{type:{name:"string"},required:!1,description:""},id:{type:{name:"string"},required:!0,description:""},label:{type:{name:"union",value:[{name:"string"},{name:"node"}]},required:!0,description:""},name:{type:{name:"string"},required:!0,description:""},onChange:{type:{name:"func"},required:!1,description:""},value:{type:{name:"string"},required:!1,description:""}}};const w=({children:e,disabled:n,className:s,...c})=>i.jsxs(be,{className:s,children:[i.jsx(je,{disabled:n,...c,children:e}),i.jsx(ye,{"aria-hidden":"true",isDisabled:n,children:i.jsx(J,{})})]});w.propTypes={children:t.node.isRequired,className:t.string,disabled:t.bool};w.defaultProps={disabled:!1};const ge="5.4rem",be=r.div`
  position: relative;
  display: inline-flex;
  flex: 1 1 auto;
  align-items: center;
...
`;w.__docgenInfo={description:"",methods:[],displayName:"Select",props:{disabled:{defaultValue:{value:"false",computed:!1},type:{name:"bool"},required:!1,description:""},children:{type:{name:"node"},required:!0,description:""},className:{type:{name:"string"},required:!1,description:""}}};function $e(e,n=300){let s;return(...c)=>{clearTimeout(s),s=setTimeout(()=>{e.apply(this,c)},n)}}const O=({name:e,maxLength:n,onChange:s,showCounter:c,...y})=>{const[m,j]=T.useState(""),[_,q]=T.useState(n),D=n?n-m.length<=0:!1,k=T.useMemo(()=>$e(q,500),[q]);T.useEffect(()=>()=>{D&&k.cancel()},[]);const V=T.useCallback(I=>{j(I.target.value),s&&s(I),k(n-I.target.value.length)},[k]);return i.jsxs(i.Fragment,{children:[i.jsx(ve,{name:e,onChange:V,maxLength:n,...y}),n&&c&&i.jsxs("div",{children:[i.jsxs(ee,{fontSize:"tiny",variant:D?"error":"placeholder",children:[Math.max(0,n-m.length)," caractères restants"]}),i.jsxs(Z,{role:"status",children:[_," caractères restants"]})]})]})};O.propTypes={maxLength:t.number,name:t.string.isRequired,onChange:t.func,showCounter:t.bool};const ve=r.textarea`
  width: 100%;
  min-height: 12rem;
  padding: ${o.medium};
  color: ${({theme:e})=>e.paragraph};
...
`;O.__docgenInfo={description:"",methods:[],displayName:"Textarea",props:{maxLength:{type:{name:"number"},required:!1,description:""},name:{type:{name:"string"},required:!0,description:""},onChange:{type:{name:"func"},required:!1,description:""},showCounter:{type:{name:"bool"},required:!1,description:""}}};const Be={component:w,title:"Field/Components"},we=r(b)`
  width: 40rem;
`,_e=r(w)`
  width: 100%;
`,qe=()=>i.jsxs(i.Fragment,{children:[i.jsxs(a,{children:[i.jsx(d,{htmlFor:"input",children:"Input"}),i.jsx(b,{name:"input",id:"input"})]}),i.jsxs(a,{children:[i.jsx(d,{htmlFor:"input_date",children:"Input Date"}),i.jsx(H,{name:"input_date",id:"input_date"})]}),i.jsxs(a,{children:[i.jsx(d,{htmlFor:"select",children:"Select"}),i.jsxs(w,{id:"select",children:[i.jsx("option",{}),i.jsx("option",{children:"Option 1"}),i.jsx("option",{children:"Option 2"}),i.jsx("option",{children:"Option 3"})]})]}),i.jsxs(a,{children:[i.jsx(d,{htmlFor:"textarea",children:"Textarea"}),i.jsx(O,{name:"textarea",id:"textarea"})]}),i.jsxs(a,{children:[i.jsx($,{label:"Option 1",name:"checkbox",id:"option_checkbox_1",value:"option_1"}),i.jsx($,{label:"Option 2 (3rem)",name:"checkbox",id:"option_checkbox_2",value:"option_2",size:"3rem"}),i.jsx($,{label:"Option 3 (4rem)",name:"checkbox",id:"option_checkbox_3",value:"option_3",size:"4rem"})]}),i.jsxs(a,{children:[i.jsx(g,{label:"Option 1",name:"radio",id:"option_radio_1",value:"option_radio_1"}),i.jsx(g,{label:"Option 2 (3rem)",name:"radio",id:"option_2",value:"option_2",size:"3rem"}),i.jsx(g,{label:"Option 3 (4rem)",name:"radio",id:"option_3",value:"option_3",size:"4rem"})]})]}),ke=()=>i.jsx(i.Fragment,{children:i.jsxs(a,{children:[i.jsx($,{label:"Option 1 with a very long label so you get what happens when it is on 2 lines",name:"checkbox",id:"option_1",value:"option_1"}),i.jsx($,{label:"Option 2 (3rem)",name:"checkbox",id:"option_2",value:"option_2",size:"3rem"}),i.jsx($,{label:"Option 3 (4rem)",name:"checkbox",id:"option_3",value:"option_3",size:"4rem"})]})}),ze=()=>i.jsxs(i.Fragment,{children:[i.jsxs(a,{children:[i.jsx(d,{htmlFor:"input",children:"Input normal"}),i.jsx(b,{id:"input",name:"input",placeholder:"Rechercher (Ex : Durée du préavis...)"})]}),i.jsxs(a,{children:[i.jsx(d,{htmlFor:"input",children:"Input avec picto 32"}),i.jsx(b,{id:"input",name:"input",icon:K,placeholder:"Rechercher (Ex : Durée du préavis...)"})]}),i.jsxs(a,{children:[i.jsx(d,{htmlFor:"input",children:"Input avec picto currency"}),i.jsx(we,{id:"input",name:"input",type:"number",icon:Q})]}),i.jsxs(a,{children:[i.jsx(d,{htmlFor:"input",children:"Input avec texte"}),i.jsx(b,{id:"input",name:"input",value:"Avec texte",placeholder:"Rechercher (Ex : Durée du préavis...)"})]}),i.jsxs(a,{children:[i.jsx(d,{htmlFor:"input",autofocus:!0,children:"Input Focus"}),i.jsx(b,{id:"input",name:"input",placeholder:"Rechercher (Ex : Durée du préavis...)"})]}),i.jsxs(a,{children:[i.jsx(d,{htmlFor:"input",children:"Input erreur"}),i.jsx(b,{name:"input",id:"input",value:"Avec texte",invalid:!0})]})]}),Se=()=>i.jsx(i.Fragment,{children:i.jsxs(a,{children:[i.jsx(d,{htmlFor:"input_date",children:"Input Date"}),i.jsx(H,{name:"input_date",id:"input_date"})]})}),Ie=()=>i.jsx(i.Fragment,{children:i.jsxs(a,{children:[i.jsxs(C,{children:[i.jsx(F,{children:"This is a legend like john"}),i.jsx(g,{label:"Option 1 in a fieldset with a legend",name:"radio",id:"option_1",value:"option_1"})]}),i.jsx("br",{}),i.jsxs(C,{children:[i.jsx(F,{isHidden:!0,children:"This is an hidden legend unlike john"}),i.jsx(g,{label:"Option 1 with an hidden legend",name:"radio",id:"option_1",value:"option_1"})]})]})}),Ne=()=>i.jsx(i.Fragment,{children:i.jsxs(a,{children:[i.jsx(g,{label:"Option 1 with a very long label so you get what happens when it is on 2 lines",name:"radio",id:"option_1",value:"option_1"}),i.jsx(g,{label:"Option 2 (3rem)",name:"radio",id:"option_2",value:"option_2",size:"3rem"}),i.jsx(g,{label:"Option 3 (4rem)",name:"radio",id:"option_3",value:"option_3",size:"4rem"})]})}),Te=()=>i.jsxs(i.Fragment,{children:[i.jsxs(a,{children:[i.jsx(d,{htmlFor:"select",children:"Select"}),i.jsxs(_e,{id:"select",children:[i.jsx("option",{children:"..."}),i.jsx("option",{children:"Option 1"}),i.jsx("option",{children:"Option 2"}),i.jsx("option",{children:"Option 3"})]})]}),i.jsxs(a,{children:[i.jsx(d,{htmlFor:"select_disabled",children:"Select disabled"}),i.jsxs(w,{id:"select_disabled",disabled:!0,children:[i.jsx("option",{children:"..."}),i.jsx("option",{children:"Option 1"}),i.jsx("option",{children:"Option 2"}),i.jsx("option",{children:"Option 3"})]})]})]}),Fe=()=>i.jsxs(i.Fragment,{children:[i.jsxs(a,{children:[i.jsx(d,{htmlFor:"textarea",children:"Textarea"}),i.jsx(O,{name:"textarea",id:"textarea"})]}),i.jsxs(a,{children:[i.jsx(d,{htmlFor:"textarea2",children:"Textarea"}),i.jsx(O,{name:"textarea2",id:"textarea2",maxLength:40,showCounter:!0})]})]});qe.__docgenInfo={description:"",methods:[],displayName:"base"};ke.__docgenInfo={description:"",methods:[],displayName:"checkbox"};ze.__docgenInfo={description:"",methods:[],displayName:"input"};Se.__docgenInfo={description:"",methods:[],displayName:"inputDate"};Ie.__docgenInfo={description:"",methods:[],displayName:"fieldsetLegend"};Ne.__docgenInfo={description:"",methods:[],displayName:"radio"};Te.__docgenInfo={description:"",methods:[],displayName:"select"};Fe.__docgenInfo={description:"",methods:[],displayName:"textarea"};export{qe as base,ke as checkbox,Be as default,Ie as fieldsetLegend,ze as input,Se as inputDate,Ne as radio,Te as select,Fe as textarea};
//# sourceMappingURL=story-0a0f74c5.js.map
