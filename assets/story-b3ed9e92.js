import{j as t,s,A as r,W as j}from"./styled-components.browser.esm-41178855.js";import{i as T}from"./ShareWhatsapp-86bedeb5.js";import{S as y}from"./index-1ba24798.js";import{P as i}from"./index-1fc0ca9a.js";import{r as l}from"./index-8db94870.js";import"./_commonjsHelpers-042e6b4d.js";import"./theme-2d6880ff.js";import"./polished.esm-d698528e.js";const o=({background:e="FFFFFF",children:n,position:p="top",text:x,textColor:f="3e486e"})=>{const[h,c]=l.useState(!1),[d,u]=l.useState(!1),a=l.useRef(null),m=h||d,g=b=>{b.preventDefault(),a.current&&a.current.blur()};return t.jsxs(w,{children:[t.jsx(v,{onMouseEnter:()=>c(!0),onMouseLeave:()=>c(!1),onFocus:()=>u(!0),onBlur:()=>u(!1),onClick:g,ref:a,showOnFocus:d,children:n}),m&&t.jsx(F,{position:p,children:t.jsx(C,{background:e,textColor:f,position:p,children:x})})]})};o.propTypes={background:i.string,children:i.node.isRequired,position:i.oneOf(["top","right","left","bottom"]),text:i.node.isRequired,textColor:i.string};const w=s.div`
  position: relative;
  display: inline-flex;
`,v=s.button`
  border: none;
...
//# sourceMappingURL=story-b3ed9e92.js.map
