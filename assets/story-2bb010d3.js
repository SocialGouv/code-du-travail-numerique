...
`,F=d.div`
  ...
  ${({text:e})=>e&&R`
      ...
      user-select: none;
    `};
`;h.__docgenInfo={description:"",methods:[],displayName:"Input",props:{icon:{defaultValue:{value:"null",computed:!1},type:{name:"elementType"},required:!1,description:""},className:{type:{name:"string"},required:!1,description:""},id:{type:{name:"string"},required:!1,description:""},invalid:{type:{name:"bool"},required:!1,description:""},name:{type:{name:"string"},required:!0,description:""},onBlur:{type:{name:"func"},required:!1,description:""},onChange:{type:{name:"func"},required:!1,description:""},placeholder:{type:{name:"string"},required:!1,description:""},ref:{type:{name:"any"},required:!1,description:""},text:{type:{name:"string"},required:!1,description:""},title:{type:{name:"string"},required:!1,description:""},type:{type:{name:"string"},required:!1,description:""},updateOnScrollDisabled:{type:{name:"bool"},required:!1,description:""},value:{type:{name:"any"},required:!1,description:""}}};function G(e){const[r,t,s]=e.split("-");return`${s}/${t}/${r}`}function M(e){if(!e)return e;const[r,t,s]=e.split("/");return`${s}-${t}-${r}`}const y=({value:e,onChange:r,invalid:t,ref:s,...m})=>{const u=f=>{r&&r(G(f.target.value))};return n.jsx(J,{...m,isValid:!t,onChange:u,type:"date",ref:s,"data-input":"true",defaultValue:M(e)})};y.propTypes=O;const J=d.input`
  padding: 0 ${a.medium};
  color: ${({theme:e})=>e.paragraph};
  font-size: ${w.sizes.default};
  font-family: "Open Sans", sans-serif;
...
//# sourceMappingURL=story-2bb010d3.js.map
