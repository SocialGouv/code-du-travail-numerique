import{s as r,j as i,A as Y}from"./styled-components.browser.esm-525a869c.js";import{A as J,S as K,E as Q}from"./ShareWhatsapp-32297fb2.js";import{S as a}from"./index-71eb6df6.js";import{P as t}from"./index-8d47fad6.js";import{b as f,s as o,a as v,f as R,c as X}from"./theme-6bad1081.js";import{R as E,r as T}from"./index-76fb7be0.js";import{S as Z}from"./index-824ca9d5.js";import{T as ee}from"./index-1e46197c.js";import"./_commonjsHelpers-de833af9.js";import"./polished.esm-3b4f0385.js";const $=({label:e,name:n,id:s,size:c,checked:y,...h})=>i.jsxs(ie,{htmlFor:s,size:c,children:[i.jsx(te,{type:"checkbox",name:n,id:s,size:c,checked:y,...h}),e]});$.propTypes={checked:t.bool,id:t.string.isRequired,label:t.oneOfType([t.string,t.node]).isRequired,name:t.string.isRequired,size:t.string};$.defaultProps={size:"1.6rem"};const ie=r.label`
  display: flex;
  font-size: ${e=>e.size};
  cursor: pointer;
  user-select: none;
...
`;$.__docgenInfo={description:"",methods:[],displayName:"InputCheckbox",props:{size:{defaultValue:{value:'"1.6rem"',computed:!1},type:{name:"string"},required:!1,description:""},checked:{type:{name:"bool"},required:!1,description:""},id:{type:{name:"string"},required:!0,description:""},label:{type:{name:"union",value:[{name:"string"},{name:"node"}]},required:!0,description:""},name:{type:{name:"string"},required:!0,description:""}}};const C=({children:e,...n})=>i.jsxs(ne,{...n,children:[" ",e]});C.propTypes={children:t.node.isRequired};const ne=r.fieldset`
  ...
  margin: 0;
  padding: 0;
`;C.__docgenInfo={description:"",methods:[],displayName:"Fieldset",props:{children:{type:{name:"node"},required:!0,description:""}}};const g=({icon:e,text:n,className:s,updateOnScrollDisabled:c,ref:y,...h})=>{const b=c?{onWheel:S=>S.target.blur()}:{};return i.jsxs(re,{className:s,children:[i.jsx(se,{hasIcon:!!e,text:n,...b,...h,ref:y}),e&&i.jsx(A,{text:n,children:i.jsx(e,{})}),n&&i.jsx(A,{text:n,children:i.jsx("span",{children:n})})]})},B={className:t.string,icon:t.elementType,id:t.string,invalid:t.bool,name:t.string.isRequired,onBlur:t.func,onChange:t.func,placeholder:t.string,ref:t.any,text:t.string,title:t.string,type:t.string,updateOnScrollDisabled:t.bool,value:t.any};g.propTypes=B;g.defaultProps={icon:null};const W="5.4rem",re=r.div`
  position: relative;
...
`,A=r.div`
  ...
  ${({text:e})=>e&&Y`
      ...
      user-select: none;
    `};
`;g.__docgenInfo={description:"",methods:[],displayName:"Input",props:{icon:{defaultValue:{value:"null",computed:!1},type:{name:"elementType"},required:!1,description:""},className:{type:{name:"string"},required:!1,description:""},id:{type:{name:"string"},required:!1,description:""},invalid:{type:{name:"bool"},required:!1,description:""},name:{type:{name:"string"},required:!0,description:""},onBlur:{type:{name:"func"},required:!1,description:""},onChange:{type:{name:"func"},required:!1,description:""},placeholder:{type:{name:"string"},required:!1,description:""},ref:{type:{name:"any"},required:!1,description:""},text:{type:{name:"string"},required:!1,description:""},title:{type:{name:"string"},required:!1,description:""},type:{type:{name:"string"},required:!1,description:""},updateOnScrollDisabled:{type:{name:"bool"},required:!1,description:""},value:{type:{name:"any"},required:!1,description:""}}};function L(e){return(e.length===2||e.length===5)&&(e+="/"),e}const H=({value:e,onChange:n,invalid:s,ref:c,...y})=>{const[h,b]=E.useState(e??""),[S,_]=E.useState(!0),[D,q]=E.useState(!1),V=l=>{const p=l.target.selectionStart,m=l.target.selectionEnd,j=l.target.value;if(l.nativeEvent.inputType==="deleteContentBackward"){b(j);return}const z=j.replace(/\D/g,"");if(z.length<=8){let u="";for(let N=0;N<z.length;N++)u=L(u),u+=z[N];u=L(u),b(u),_(P(u)),n&&n(u),setTimeout(()=>{m<u.length-1&&l.target.setSelectionRange(p,m)},0)}},I=l=>{const p=l.target.value;if(p&&p!==""){const m=p.split("-"),j=m[0]??"",k=m[1]??"",u=`${m[2]??""}/${k}/${j}`;b(u),_(!0),n&&n(u)}},M=()=>{const l=h.split("/"),p=l[0]??"",m=l[1]??"";return`${l[2]??""}-${m}-${p}`},P=l=>{if(l&&l.length===10){const p=l.split("/"),m=isNaN(Number(p[0]))?null:Number(p[0]),j=isNaN(Number(p[1]))?null:Number(p[1]),k=isNaN(Number(p[2]))?null:Number(p[2]),z=k&&k>=1900&&k<=2100,u=j&&j>=1&&j<=12,N=m&&m>=1&&m<=31,G=/^\d{2}\/\d{2}\/\d{4}$/.test(l);return z&&u&&N&&G}return!1},U=()=>{q(!1),_(P(h))};return i.jsxs(oe,{isFocus:D,isValid:s===!0?!1:s===!1?!0:S,children:[i.jsx(ae,{value:h,onChange:V,placeholder:"jj/mm/aaaa",onFocus:()=>q(!0),onBlur:U,...y,ref:c}),i.jsxs(de,{children:[i.jsx(ce,{children:i.jsx(pe,{width:"100%",height:"100%"})}),i.jsx(le,{type:"date","aria-disabled":!0,tabIndex:-1,min:"1900-01-01",max:"2100-01-01",maxlength:"11",value:M(),onChange:I})]})]})};H.propTypes=B;const oe=r.div`
  display: flex;
  flex-direction: row;
...
`;w.__docgenInfo={description:"",methods:[],displayName:"Select",props:{disabled:{defaultValue:{value:"false",computed:!1},type:{name:"bool"},required:!1,description:""},children:{type:{name:"node"},required:!0,description:""},className:{type:{name:"string"},required:!1,description:""}}};function $e(e,n=300){let s;return(...c)=>{clearTimeout(s),s=setTimeout(()=>{e.apply(this,c)},n)}}const O=({name:e,maxLength:n,onChange:s,showCounter:c,...y})=>{const[h,b]=T.useState(""),[S,_]=T.useState(n),D=n?n-h.length<=0:!1,q=T.useMemo(()=>$e(_,500),[_]);T.useEffect(()=>()=>{D&&q.cancel()},[]);const V=T.useCallback(I=>{b(I.target.value),s&&s(I),q(n-I.target.value.length)},[q]);return i.jsxs(i.Fragment,{children:[i.jsx(ve,{name:e,onChange:V,maxLength:n,...y}),n&&c&&i.jsxs("div",{children:[i.jsxs(ee,{fontSize:"tiny",variant:D?"error":"placeholder",children:[Math.max(0,n-h.length)," caractères restants"]}),i.jsxs(Z,{role:"status",children:[S," caractères restants"]})]})]})};O.propTypes={maxLength:t.number,name:t.string.isRequired,onChange:t.func,showCounter:t.bool};const ve=r.textarea`
  width: 100%;
  min-height: 12rem;
  padding: ${o.medium};
  color: ${({theme:e})=>e.paragraph};
...
//# sourceMappingURL=story-77d43893.js.map
