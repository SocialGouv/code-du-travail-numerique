import{j as t,s,A as r,W as j}from"./styled-components.browser.esm-beddb3d4.js";import{j as T}from"./ShareWhatsapp-5fd28490.js";import{S as y}from"./index-1f204f3d.js";import{P as i}from"./index-8d47fad6.js";import{r as l}from"./index-76fb7be0.js";import"./_commonjsHelpers-de833af9.js";import"./theme-a9d9eda1.js";import"./polished.esm-21626a5b.js";const o=({background:e="FFFFFF",children:n,position:p="top",text:x,textColor:f="3e486e"})=>{const[h,c]=l.useState(!1),[d,u]=l.useState(!1),a=l.useRef(null),m=h||d,g=b=>{b.preventDefault(),a.current&&a.current.blur()};return t.jsxs(w,{children:[t.jsx(v,{onMouseEnter:()=>c(!0),onMouseLeave:()=>c(!1),onFocus:()=>u(!0),onBlur:()=>u(!1),onClick:g,ref:a,showOnFocus:d,children:n}),m&&t.jsx(F,{position:p,children:t.jsx(C,{background:e,textColor:f,position:p,children:x})})]})};o.propTypes={background:i.string,children:i.node.isRequired,position:i.oneOf(["top","right","left","bottom"]),text:i.node.isRequired,textColor:i.string};const w=s.div`
  position: relative;
  display: inline-flex;
`,v=s.button`
  border: none;
...
//# sourceMappingURL=story-4889301b.js.map
