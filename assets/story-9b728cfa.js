import{j as e,s as f}from"./styled-components.browser.esm-beddb3d4.js";import{B as b}from"./index-36bb601e.js";import{S as u}from"./index-1f204f3d.js";import{T as p}from"./index-06ea9a4c.js";import{P as s}from"./index-8d47fad6.js";import{R as y,r as x}from"./index-76fb7be0.js";import{F as $}from"./index-5c1ed3ed.js";import{a as j,s as S}from"./theme-a9d9eda1.js";import"./_commonjsHelpers-de833af9.js";import"./polished.esm-21626a5b.js";import"./ShareWhatsapp-5fd28490.js";import"./index-6b952e87.js";import"./TitleParagraph-af12ec5b.js";const r=({button:n,children:t,initialSize:a,tolerance:o,listContainer:C,query:g,stepSize:h})=>{const i=y.Children.count(t),[d,c]=x.useState(i);x.useEffect(()=>{const l=o?a+o:a*1.2+1;c(l>=i?i:a)},[i,a,o,g]);const k=x.useCallback(()=>{if(!h)return c(i);const l=d+h;return(o?l+o:l*1.2+1)>=i?c(i):c(l)},[h,o,d,i]),w=i>d;return e.jsxs(e.Fragment,{children:[e.jsx(C,{children:y.Children.toArray(t).slice(0,d)}),w&&e.jsx(z,{children:n(k)})]})};r.propTypes={button:s.func,children:s.node.isRequired,initialSize:s.number,listContainer:s.elementType,query:s.string,stepSize:s.number,tolerance:s.number};const q=n=>e.jsx(V,{type:"button",onClick:n,children:"Voir plus"});r.defaultProps={button:q,initialSize:7,listContainer:$,query:""};const z=f.div`
  display: flex;
...
//# sourceMappingURL=story-9b728cfa.js.map
