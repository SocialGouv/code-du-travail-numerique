// mettre les articles dont nous avons besoin
export default {
  "R3111-1": {
    texte: "A l'exception du chapitre II du titre III ainsi que des titres VI et VII, le présent livre définit les règles d'ordre public, le champ de la négociation collective et les règles supplétives applicables en l'absence d'accord."
  },
  "L3111-1": {
    texte: "Les dispositions du présent livre sont applicables aux employeurs de droit privé ainsi qu'à leurs salariés.   Elles sont également applicables aux établissements publics à caractère industriel et commercial."
  },
  //période d'essai
  "L1221-19": {
    texte: "Le contrat de travail à durée indéterminée peut comporter une période d'essai dont la durée maximale est :<br><br> 1° Pour les ouvriers et les employés, de deux mois ; <br><br>2° Pour les agents de maîtrise et les techniciens, de trois mois ; <br><br>3° Pour les cadres, de quatre mois."
  },
  "L1221-20": {
    texte: "La période d'essai permet à l'employeur d'évaluer les compétences du salarié dans son travail, notamment au regard de son expérience, et au salarié d'apprécier si les fonctions occupées lui conviennent. "
  },
  "L1221-21": {
  ...
  "D3121-7": {
    texte: "Les recours hiérarchiques contre les décisions prévues aux articles D. 3121-5 et D. 3121-6 sont formés devant le directeur régional des entreprises, de la concurrence, de la consommation, du travail et de l'emploi dans le délai d'un mois suivant la date à laquelle les intéressés en ont reçu notification."
  },

  // RC

  "L1237-11": {
    texte: "<p>L'employeur et le salarié peuvent convenir en commun des conditions de la rupture du contrat de travail qui les lie.</p><p>La rupture conventionnelle, exclusive du licenciement ou de la démission, ne peut être imposée par l'une ou l'autre des parties.</p><p>Elle résulte d'une convention signée par les parties au contrat. Elle est soumise aux dispositions de la présente section destinées à garantir la liberté du consentement des parties.</p>"
  },
  "L1237-12": {
    texte: "<p>Les parties au contrat conviennent du principe d'une rupture conventionnelle lors d'un ou plusieurs entretiens au cours desquels le salarié peut se faire assister :<br>1° Soit par une personne de son choix appartenant au personnel de l'entreprise, qu'il s'agisse d'un salarié titulaire d'un mandat syndical ou d'un salarié membre d'une institution représentative du personnel ou tout autre salarié ;<br>2° Soit, en l'absence d'institution représentative du personnel dans l'entreprise, par un conseiller du salarié choisi sur une liste dressée par l'autorité administrative.</br><p>Lors du ou des entretiens, l'employeur a la faculté de se faire assister quand le salarié en fait lui-même usage. Le salarié en informe l'employeur auparavant ; si l'employeur souhaite également se faire assister, il en informe à son tour le salarié.</p><p>L'employeur peut se faire assister par une personne de son choix appartenant au personnel de l'entreprise ou, dans les entreprises de moins de cinquante salariés, par une personne appartenant à son organisation syndicale d'employeurs ou par un autre employeur relevant de la même branche.</p>"
  },
  "L1237-13": {
...
3° Des accords collectifs mentionnés à l'article L. 1237-17.`
  ...
  "R1237-3": {
    texte: `L'autorité administrative compétente pour l'homologation de la convention de rupture prévue à l'article L. 1237-14 est le directeur régional des entreprises, de la concurrence, de la consommation, du travail et de l'emploi du lieu où est établi l'employeur.
NOTA :
...
Ces dispositions ne sont pas applicables pendant la période d'essai.`
  ...
  "L1234-9": {
    texte: `Le salarié titulaire d'un contrat de travail à durée indéterminée, licencié alors qu'il compte 8 mois d'ancienneté ininterrompus au service du même employeur, a droit, sauf en cas de faute grave, à une indemnité de licenciement.
