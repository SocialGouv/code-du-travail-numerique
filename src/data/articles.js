...
export default {
  ...
  "L1221-19": {
    texte:
      "Le contrat de travail à durée indéterminée peut comporter une période d'essai dont la durée maximale est :<br><br> 1° Pour les ouvriers et les employés, de deux mois ; <br><br>2° Pour les agents de maîtrise et les techniciens, de trois mois ; <br><br>3° Pour les cadres, de quatre mois."
  },
  "L1221-20": {
    texte:
  ...
  "L3121-18": {
    texte:
      "La durée quotidienne de travail effectif par salarié ne peut excéder dix heures, sauf :<p>1° En cas de dérogation accordée par l'inspecteur du travail dans des conditions déterminées par décret ;</p><p>2° En cas d'urgence, dans des conditions déterminées par décret ;</p><p>3° Dans les cas prévus à l'article L. 3121-19.</p>"
  },
   "L3121-19": {
    texte:
   ...
   "D3121-5": {
    texte:
      "La demande de dépassement de la durée quotidienne maximale de travail, accompagnée des justifications utiles et de l'avis du comité social et économique, s'il existe, est adressée par l'employeur à l'inspecteur du travail.<p>L'inspecteur du travail fait connaître sa décision dans un délai de quinze jours à compter de la date de réception de la demande à l'employeur et aux représentants du personnel.</p>"
      },
   "D3121-6": {
    texte:
