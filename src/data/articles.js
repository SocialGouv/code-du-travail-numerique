...
export default {
  ...
  "L1221-23": {
    texte:
      "La période d'essai et la possibilité de la renouveler ne se présument pas. Elles sont expressément stipulées dans la lettre d'engagement ou le contrat de travai"
  }
};
