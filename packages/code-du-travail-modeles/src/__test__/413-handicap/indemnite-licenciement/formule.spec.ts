...
describe("Indemnité légale de licenciement avec une formule personnalisée et expliquée pour la CC 413", () => {
  test.each`
    ...
    ${"Cadres"}                                                                                                                      | ${23 / 12}        | ${15}      | ${"1/2 * Sref * A1 + Sref * A2"} | ${["A1 : Année de service en qualité de non-cadres (1.92 an)", "A2 : Année de service en qualité de cadre (13.08 an)", "Sref : Salaire de référence (1000 €)"]}
    ...
    ${"Cadres directeurs généraux, directeurs de centre de formation en travail social et directeurs d'établissement ou de service"} | ${23 / 12}        | ${15}      | ${"1/2 * Sref * A1 + Sref * A2"} | ${["A1 : Année de service en qualité de non-cadres (1.92 an)", "A2 : Année de service en qualité de cadre (13.08 an)", "Sref : Salaire de référence (1000 €)"]}
