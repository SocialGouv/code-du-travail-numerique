...
describe("CC 2941", () => {
  describe("Calcul de l'ancienneté", () => {
    test.each`
      ...
      ${[{ durationInMonth: 0, motif: "Absence pour maladie non professionnelle" }, { durationInMonth: 0, motif: "Arrêt maladie lié à un accident de trajet" }, { durationInMonth: 0, motif: "Congé sabbatique" }, { durationInMonth: 1, motif: "Congé pour création d'entreprise" }, { durationInMonth: 0, motif: "Congé parental d'éducation" }, { durationInMonth: 0, motif: "Congés sans solde" }, { durationInMonth: 0, motif: "Grève" }, { durationInMonth: 0, motif: "Mise à pied" }, { durationInMonth: 0, motif: "Congé de paternité" }]} | ${"20/02/2020"} | ${"20/02/2021"} | ${0.9166666666666666}
      ${[{ durationInMonth: 0.5, motif: "Absence pour maladie non professionnelle", startedAt: "02/02/2011" }, { durationInMonth: 0.75, motif: "Absence pour maladie non professionnelle", startedAt: "02/02/2013" }, { durationInMonth: 2.5, motif: "Absence pour maladie non professionnelle", startedAt: "02/02/2017" }]}                                                                                                                                                                                                                       | ${"01/01/2008"} | ${"01/01/2021"} | ${12.875}
    `(
