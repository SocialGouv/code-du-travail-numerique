...
describe("Vérification des notifications", () => {
  test.each`
    ...
    ${"Salariés du particulier employeur"}             | ${'Si la lettre de départ à la retraite a été présentée avant le 01/01/2022, la durée de préavis peut ne pas correspondre au résultat donné. En effet, jusqu’au 31/12/21 c’est la convention collective "Salariés du particulier employeur (IDCC 2111)" qui s’appliquait. Celle-ci a fusionné avec la convention collective “Assistants maternels du particulier employeur (IDCC 2395)” pour former la convention collective “Particuliers employeurs et emploi à domicile (IDCC 3239)” applicable à partir du 01/01/2022.'}
