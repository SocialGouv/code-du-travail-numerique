...
describe("Indemnité légale de licenciement avec une formule personnalisée et expliquée pour la CC 2264", () => {
  test.each`
    ...
    ${"Ouvriers, employés, techniciens et agents de maîtrise"} | ${undefined}      | ${11 / 12} | ${""}                                                        | ${["Sref : Salaire de référence (1000 €)"]}
    ${"Ouvriers, employés, techniciens et agents de maîtrise"} | ${undefined}      | ${1.5}     | ${"1/5 * Sref * A"}                                          | ${["A : Ancienneté totale (1.5 an)", "Sref : Salaire de référence (1000 €)"]}
    ${"Ouvriers, employés, techniciens et agents de maîtrise"} | ${undefined}      | ${12}      | ${"(1/5 * Sref * A1) + (2/5 * Sref * A2)"}                   | ${["A1 : Années d'ancienneté de 10 ans ou moins (10 ans)", "A2 : Ancienneté au delà de 10 ans (2 ans)", "Sref : Salaire de référence (1000 €)"]}
    ${"Cadres"}                                                | ${undefined}      | ${11 / 12} | ${""}                                                        | ${["Sref : Salaire de référence (1000 €)"]}
    ...
    ${"Ouvriers, employés, techniciens et agents de maîtrise"} | ${10}             | ${12}      | ${"(1/5 * Sref * A1) + (2/5 * Sref * A2)"}                   | ${["A1 : Années d'ancienneté de 10 ans ou moins (10 ans)", "A2 : Ancienneté au delà de 10 ans (2 ans)", "Sref : Salaire de référence (1000 €)"]}
