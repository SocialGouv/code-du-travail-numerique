...
describe("Indemnité légale de licenciement avec une formule personnalisée et expliquée pour la CC 2264", () => {
  test.each`
    ...
    ${"Non-cadres"} | ${undefined}      | ${12}      | ${"(1/5 * Sref * A1) + (2/5 * Sref * A2)"}                   | ${["A1 : Ancienneté de 10 ans ou moins (10 ans)", "A2 : Ancienneté au-delà de 10 ans (2 ans)", "Sref : Salaire de référence (1000 €)"]}
