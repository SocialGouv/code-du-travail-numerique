...
describe("Indemnité conventionnel de licenciement pour la CC 1516", () => {
  test.each`
    seniority | salary  | ccSalary | inaptitude | expectedCompensation
    ${0}      | ${0}    | ${0}     | ${"oui"}   | ${0}
    ${0}      | ${0}    | ${0}     | ${"non"}   | ${0}
    ${0.5}    | ${1000} | ${1000}  | ${"non"}   | ${0}
    ${8 / 12} | ${1000} | ${1000}  | ${"non"}   | ${166.667}
    ${2}      | ${2000} | ${2000}  | ${"non"}   | ${1000}
    ${2}      | ${2000} | ${2000}  | ${"oui"}   | ${2000}
    ${2}      | ${300}  | ${2000}  | ${"non"}   | ${1000}
  `(
    "ancienneté: $seniority mois, salaire de référence: $salary, inaptitude: $inaptitude => $expectedCompensation €",
    ({ seniority, salary, ccSalary, expectedCompensation, inaptitude }) => {
      const result = engine
        .setSituation({
