...
describe("Indemnité légale de licenciement avec une formule personnalisée et expliquée pour la CC 44", () => {
  test.each`
    ...
    ${CategoryPro44.inge}        | ${false}         | ${40} | ${10}     | ${"4 / 10 * Sref * A1 + 6 / 10 * Sref * A2"}                                 | ${["Sref : Salaire de référence (1000 €)", "A1: Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (10 ans)", "A2: Années au-delà de 10 ans pour la tranche de 10 à 15 ans (0 an)"]}
    ...
    ${CategoryPro44.inge}        | ${false}         | ${48} | ${10}     | ${"Sref + 4 / 10 * Sref * A1 + 6 / 10 * Sref * A2"}                          | ${["Sref : Salaire de référence (1000 €)", "A1: Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (10 ans)", "A2: Années au-delà de 10 ans pour la tranche de 10 à 15 ans (0 an)"]}
    ...
    ${CategoryPro44.inge}        | ${false}         | ${58} | ${10}     | ${"2 * Sref + 4 / 10 * Sref * A1 + 6 / 10 * Sref * A2"}                      | ${["Sref : Salaire de référence (1000 €)", "A1: Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (10 ans)", "A2: Années au-delà de 10 ans pour la tranche de 10 à 15 ans (0 an)"]}
    ...
    ${CategoryPro44.techniciens} | ${true}          | ${30} | ${2}      | ${"Sref + 3 / 10 * Sref * A1"}                                               | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (2 ans)"]}
    ${CategoryPro44.techniciens} | ${true}          | ${30} | ${5}      | ${"Sref + 3 / 10 * Sref * A1"}                                               | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (5 ans)"]}
    ${CategoryPro44.techniciens} | ${true}          | ${52} | ${0.75}   | ${""}                                                                        | ${[]}
    ${CategoryPro44.techniciens} | ${true}          | ${52} | ${1.5}    | ${"Sref"}                                                                    | ${["Sref : Salaire de référence (1000 €)"]}
    ${CategoryPro44.techniciens} | ${true}          | ${52} | ${2}      | ${"Sref + 3 / 10 * Sref * A1"}                                               | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (2 ans)"]}
    ...
    ${CategoryPro44.techniciens} | ${true}          | ${56} | ${2}      | ${"Sref + 3 / 10 * Sref * A1"}                                               | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (2 ans)"]}
    ${CategoryPro44.techniciens} | ${true}          | ${56} | ${5}      | ${"Sref + 3 / 10 * Sref * A1"}                                               | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (5 ans)"]}
    ${CategoryPro44.inge}        | ${true}          | ${30} | ${0.75}   | ${""}                                                                        | ${[]}
    ${CategoryPro44.inge}        | ${true}          | ${30} | ${1.5}    | ${"Sref"}                                                                    | ${["Sref : Salaire de référence (1000 €)"]}
    ${CategoryPro44.inge}        | ${true}          | ${30} | ${2}      | ${"Sref + 4 / 10 * Sref * A1"}                                               | ${["Sref : Salaire de référence (1000 €)", "A1: Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (2 ans)"]}
    ${CategoryPro44.inge}        | ${true}          | ${30} | ${5}      | ${"Sref + 4 / 10 * Sref * A1"}                                               | ${["Sref : Salaire de référence (1000 €)", "A1: Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (5 ans)"]}
    ${CategoryPro44.inge}        | ${true}          | ${52} | ${0.75}   | ${""}                                                                        | ${[]}
    ${CategoryPro44.inge}        | ${true}          | ${52} | ${1.5}    | ${"Sref"}                                                                    | ${["Sref : Salaire de référence (1000 €)"]}
    ${CategoryPro44.inge}        | ${true}          | ${52} | ${2}      | ${"Sref + 4 / 10 * Sref * A1"}                                               | ${["Sref : Salaire de référence (1000 €)", "A1: Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (2 ans)"]}
    ...
    ${CategoryPro44.inge}        | ${true}          | ${56} | ${2}      | ${"Sref + 4 / 10 * Sref * A1"}                                               | ${["Sref : Salaire de référence (1000 €)", "A1: Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (2 ans)"]}
    ${CategoryPro44.inge}        | ${true}          | ${56} | ${5}      | ${"Sref + 4 / 10 * Sref * A1"}                                               | ${["Sref : Salaire de référence (1000 €)", "A1: Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (5 ans)"]}
  `(
