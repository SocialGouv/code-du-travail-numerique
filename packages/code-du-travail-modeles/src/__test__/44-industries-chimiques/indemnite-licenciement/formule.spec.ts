...
describe("Indemnité légale de licenciement avec une formule personnalisée et expliquée pour la CC 44", () => {
  test.each`
    ...
    ${CategoryPro44.inge}        | ${true}          | ${52} | ${5}      | ${"4 / 10 * Sref * A1"}                                                      | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (5 ans)"]}
