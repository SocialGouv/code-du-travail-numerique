...
describe("Indemnité légale de licenciement avec une formule personnalisée et expliquée pour la CC 16", () => {
  ...
  describe("Pour un Ingénieur et Cadre", () => {
    test.each`
      ...
      ${31}     | ${undefined} | ${true}    | ${61} | ${true}               | ${"((4 / 10 * Sref * A1) - (20% * (4 / 10 * Sref * A1))) + (4 * Sref)"}                                                   | ${["A1 : Ancienneté totale (31 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${31}     | ${undefined} | ${true}    | ${61} | ${false}              | ${"(4 / 10 * Sref * A1) + (4 * Sref)"}                                                                                    | ${["A1 : Ancienneté totale (31 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${15}     | ${6}         | ${true}    | ${66} | ${false}              | ${""}                                                                                                                     | ${[]}
      ...
      ${21}     | ${undefined} | ${true}    | ${61} | ${true}               | ${"((4 / 10 * Sref * A1) - (20% * (4 / 10 * Sref * A1))) + (3 * Sref)"}                                                   | ${["A1 : Ancienneté totale (21 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${21}     | ${undefined} | ${true}    | ${61} | ${false}              | ${"(4 / 10 * Sref * A1) + (3 * Sref)"}                                                                                    | ${["A1 : Ancienneté totale (21 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${5}      | ${6}         | ${true}    | ${66} | ${false}              | ${""}                                                                                                                     | ${[]}
      ...
      ${11}     | ${undefined} | ${true}    | ${61} | ${true}               | ${"((4 / 10 * Sref * A1) - (20% * (4 / 10 * Sref * A1))) + (2 * Sref)"}                                                   | ${["A1 : Ancienneté totale (11 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${11}     | ${undefined} | ${true}    | ${61} | ${false}              | ${"(4 / 10 * Sref * A1) + (2 * Sref)"}                                                                                    | ${["A1 : Ancienneté totale (11 ans)", "Sref : Salaire de référence (1000 €)"]}
      ...
      ${3}      | ${undefined} | ${true}    | ${61} | ${true}               | ${"(4 / 10 * Sref * A1) - (20% * (4 / 10 * Sref * A1))"}                                                                  | ${["A1 : Ancienneté totale (3 ans)", "Sref : Salaire de référence (1000 €)"]}
