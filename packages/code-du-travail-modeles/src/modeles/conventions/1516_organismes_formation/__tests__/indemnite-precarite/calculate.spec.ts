  ...
  test.each([
    {
      ...
      expectedReferences: [
        {
          article: "Article 5.4.3 de la convention collective",
          url: "https://www.legifrance.gouv.fr/conv_coll/id/KALIARTI000047382739/?idConteneur=KALICONT000005635435",
        },
        {
      ...
      situation: { "contrat salarié . type de cdd": "'usage formateurs'" },
    },
    {
