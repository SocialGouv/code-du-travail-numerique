...
describe("Formule indemnité licenciement - 1486", () => {
  describe("Formules avant le 1er mai 2023", () => {
      ...
      `(
        ...
        ({ seniority, expectedFormula, expectedExplanations }) => {
          engine.setSituation({
            ...
            "contrat salarié . convention collective . bureaux études techniques . indemnité de licenciement . anciennes règles . type de licenciement": `'${TypeLicenciement1486.refus}'`,
    ...
    describe("Pour un Autre Licenciement", () => {
      ...
      `(
        ...
        ({ category, seniority, expectedFormula, expectedExplanations }) => {
          engine.setSituation({
            "contrat salarié . convention collective": "'IDCC1486'",
            "contrat salarié . convention collective . bureaux études techniques . indemnité de licenciement . anciennes règles . type de licenciement": `'${TypeLicenciement1486.autre}'`,
  ...
  describe("Formules à partir du 1er mai 2023)", () => {
    test.each`
      category                    | seniority | expectedFormula     | expectedExplanations
      ${CatPro1486.ingeCadre}     | ${0}      | ${""}               | ${[]}
      ...
      ${CatPro1486.etam}          | ${15}     | ${"1/3 * Sref * A"} | ${["A : Ancienneté totale (15 ans)", "Sref : Salaire de référence (1000 €)"]}
    `(
      "Formule $expectedFormula avec $seniority ans, catégorie $category",
      ({ category, seniority, expectedFormula, expectedExplanations }) => {
        engine.setSituation({
