...
describe("CC 413", () => {
  ...
  describe("Calcul de l'ancienneté pour un cadre", () => {
    test.each`
      ...
      ${[]}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | ${"01/01/2020"} | ${"01/01/2022"} | ${"01/01/2021"}   | ${2}               | ${{ "contrat salarié . convention collective . établissement handicap . indemnité de licenciement . catégorie professionnelle . non cadre durant une période . temps": 1 }}
      ${[{ durationInMonth: 1, motif: { key: MotifKeys.congesSansSolde }, startedAt: "01/05/2020" }]}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | ${"01/01/2020"} | ${"01/01/2022"} | ${"01/01/2021"}   | ${2 - 1 / 12}      | ${{ "contrat salarié . convention collective . établissement handicap . indemnité de licenciement . catégorie professionnelle . non cadre durant une période . temps": 1 - 1 / 12 }}
      ${[{ durationInMonth: 1, motif: { key: MotifKeys.congesSansSolde }, startedAt: "01/05/2021" }]}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | ${"01/01/2020"} | ${"01/01/2022"} | ${"01/01/2021"}   | ${2 - 1 / 12}      | ${{ "contrat salarié . convention collective . établissement handicap . indemnité de licenciement . catégorie professionnelle . non cadre durant une période . temps": 1 }}
      ${[]}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | ${"01/01/2012"} | ${"01/01/2022"} | ${"01/01/2000"}   | ${10}              | ${{ "contrat salarié . convention collective . établissement handicap . indemnité de licenciement . catégorie professionnelle . non cadre durant une période . temps": 0 }}
    `(
      "Calcul de l'ancienneté avec $entryDate et $exitDate en attendant $expectedAnciennete an",
      ({
        absences,
