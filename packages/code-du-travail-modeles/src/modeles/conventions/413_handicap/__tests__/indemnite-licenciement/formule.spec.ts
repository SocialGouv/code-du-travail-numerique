...
describe("Formule indemnité licenciement - 413", () => {
  ...
  describe("Cas mixte", () => {
    test.each`
      ...
      ${"Cadres directeurs généraux, directeurs de centre de formation en travail social et directeurs d'établissement ou de service"} | ${13}             | ${22.5}   | ${"(1 / 2 * Sref * A1) + (Sref * A2)"} | ${["A1 : Année de service en qualité de non-cadres (13 ans)", "A2 : Année de service en qualité de cadre (9.5 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${"Cadres directeurs généraux, directeurs de centre de formation en travail social et directeurs d'établissement ou de service"} | ${13}             | ${22.5}   | ${"(1 / 2 * Sref * A1) + (Sref * A2)"} | ${["A1 : Année de service en qualité de non-cadres (13 ans)", "A2 : Année de service en qualité de cadre (9.5 ans)", "Sref : Salaire de référence (1000 €)"]}
      ...
      ${"Cadres directeurs généraux, directeurs de centre de formation en travail social et directeurs d'établissement ou de service"} | ${2}              | ${15}     | ${"(1 / 2 * Sref * A1) + (12 * Sref)"} | ${["A1 : Année de service en qualité de non-cadres (2 ans)", "Sref : Salaire de référence (1000 €)"]}
    `(
