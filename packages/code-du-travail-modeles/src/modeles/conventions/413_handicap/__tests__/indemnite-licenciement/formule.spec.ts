...
describe("Indemnité légale de licenciement avec une formule personnalisée et expliquée pour la CC 413", () => {
  describe("Cas général", () => {
    test.each`
      ...
      ${"Cadres"}                                                                                                                      | ${23 / 12} | ${""}                 | ${[]}
      ${"Cadres"}                                                                                                                      | ${2}       | ${""}                 | ${[]}
      ${"Cadres"}                                                                                                                      | ${25 / 12} | ${"Sref * A"}         | ${["A : Ancienneté totale (~2.08 ans: valeur arrondi)", "Sref : Salaire de référence (1000 €)"]}
      ...
      ${"Cadres directeurs généraux, directeurs de centre de formation en travail social et directeurs d'établissement ou de service"} | ${25 / 12} | ${"Sref * A"}         | ${["A : Ancienneté totale (~2.08 ans: valeur arrondi)", "Sref : Salaire de référence (1000 €)"]}
  ...
  describe("Cas mixte", () => {
    test.each`
      ...
      ${"Cadres"}                                                                                                                      | ${23 / 12}        | ${15}     | ${"(1 / 2 * Sref * A1) + (Sref * A2)"} | ${["A1 : Année de service en qualité de non-cadres (~1.92 an: valeur arrondi)", "A2 : Année de service en qualité de cadre (~13.08 ans: valeur arrondi)", "Sref : Salaire de référence (1000 €)"]}
      ${"Cadres"}                                                                                                                      | ${25 / 12}        | ${15}     | ${"(1 / 2 * Sref * A1) + (Sref * A2)"} | ${["A1 : Année de service en qualité de non-cadres (~2.08 ans: valeur arrondi)", "A2 : Année de service en qualité de cadre (~12.92 ans: valeur arrondi)", "Sref : Salaire de référence (1000 €)"]}
      ${"Cadres directeurs généraux, directeurs de centre de formation en travail social et directeurs d'établissement ou de service"} | ${23 / 12}        | ${15}     | ${"(1 / 2 * Sref * A1) + (Sref * A2)"} | ${["A1 : Année de service en qualité de non-cadres (~1.92 an: valeur arrondi)", "A2 : Année de service en qualité de cadre (~13.08 ans: valeur arrondi)", "Sref : Salaire de référence (1000 €)"]}
      ${"Cadres directeurs généraux, directeurs de centre de formation en travail social et directeurs d'établissement ou de service"} | ${25 / 12}        | ${15}     | ${"(1 / 2 * Sref * A1) + (Sref * A2)"} | ${["A1 : Année de service en qualité de non-cadres (~2.08 ans: valeur arrondi)", "A2 : Année de service en qualité de cadre (~12.92 ans: valeur arrondi)", "Sref : Salaire de référence (1000 €)"]}
    `(
