...
const engine = new PreavisLicenciementPublicodes(modelsPreavisLicenciement, "1996");
      
describe("Test de la fonctionnalité 'calculate'", () => {
  test.each([{"expectedResult":{"expectedValue":3,"unit":"mois"},"expectedReferences":[{"article":"article 6 des dispositions particulières aux cadres","url":"https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=1FBE77FACF3A20C70C10CCE69F359D7B.tplgfr23s_1?idArticle=KALIARTI000005829442&cidTexte=KALITEXT000005671154&dateTexte=29990101&categorieLien=id"}],"expectedNotifications":[],"situation":{"contrat salarié . convention collective . pharmacie . catégorie professionnelle":"'Cadres'"}},
