...
describe("CC 1996", () => {
  describe("Calcul de l'ancienneté", () => {
    test.each`
      ...
      ${"12 (13 mois continue d'absence à partir du 01/12)"}                 | ${[{ durationInMonth: 13, motif: { key: MotifKeys.maladieNonPro, value: 1 }, startedAt: "01/12/2020" }]}                                                                                                                                                                                                                                                                                   | ${"01/01/2012"} | ${"01/01/2024"} | ${11}
    `(
