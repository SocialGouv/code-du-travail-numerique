...
describe("CC 1996", () => {
  describe("Calcul de l'ancienneté", () => {
    test.each`
      ...
      ${"12 ans - 5 mois sur une année et 4 mois sur une autre"}             | ${[{ durationInMonth: 5, motif: { key: MotifKeys.maladieNonPro, value: 1 }, startedAt: "01/08/2018" }, { durationInMonth: 4, motif: { key: MotifKeys.maladieNonPro, value: 1 }, startedAt: "01/01/2019" }]}                                                                                                                                                                                | ${"01/01/2012"} | ${"01/01/2024"} | ${12}
      ${"12 ans - 7 mois sur une année et 8 mois sur une autre"}             | ${[{ durationInMonth: 7, motif: { key: MotifKeys.maladieNonPro, value: 1 }, startedAt: "01/06/2018" }, { durationInMonth: 8, motif: { key: MotifKeys.maladieNonPro, value: 1 }, startedAt: "01/01/2019" }]}                                                                                                                                                                                | ${"01/01/2012"} | ${"01/01/2024"} | ${11}
      ${"12 ans - 7 mois sur une année et 4 mois sur une autre"}             | ${[{ durationInMonth: 7, motif: { key: MotifKeys.maladieNonPro, value: 1 }, startedAt: "01/06/2018" }, { durationInMonth: 4, motif: { key: MotifKeys.maladieNonPro, value: 1 }, startedAt: "01/01/2019" }]}                                                                                                                                                                                | ${"01/01/2012"} | ${"01/01/2024"} | ${11.5}
