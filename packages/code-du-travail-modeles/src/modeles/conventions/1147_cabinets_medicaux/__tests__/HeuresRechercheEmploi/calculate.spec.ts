  ...
  test.each([
    {
      ...
      expectedReferences: [
        {
          article: "Article 26",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do?idArticle=KALIARTI000005856091&cidTexte=KALITEXT000005681857&dateTexte=20190707",
        },
      ],
      expectedNotifications: [],
      situation: {
        "contrat salarié . convention collective . cabinets médicaux . typeRupture":
          "'Démission'",
      },
    },
    {
      ...
      expectedNotifications: [
        ...
        "L'employeur et le salarié peuvent décider ensemble que ces heures seront cumulées en une seule journée de 8 heures tous les 4 jours.",
      ],
      situation: {
        "contrat salarié . convention collective . cabinets médicaux . typeRupture":
          "'Licenciement'",
