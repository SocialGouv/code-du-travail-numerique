...
describe("Test de la fonctionnalité 'calculate'", () => {
  test.each([{"expectedResult":{"expectedValue":300,"unit":"€"},"expectedReferences":[{"article":"Article 9 de l'accord du 10 mai 2010 relatif à l'activité d'optimisation de linéaires","url":"https://www.legifrance.gouv.fr/affichIDCCArticle.do?idArticle=KALIARTI000023105275&cidTexte=KALITEXT000023105252&dateTexte=20190918"}],"expectedNotifications":[],"expectedFormula":{"formula":"1/10 * Sref","explanations":["Sref : Salaire de référence (3000 €)"]},"situation":{"contrat salarié . type de cdd":"'CDD d'optimisation linéaire'"}},
          {"expectedResult":{"expectedValue":300,"unit":"€"},"expectedReferences":[{"article":"Article 9 de l'accord du 13 février 2006 Activités de l'animation commerciale","url":"https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=793A05966FD38DF94E5C833A2BA3BAA6.tplgfr35s_3?idArticle=KALIARTI000005853800&cidTexte=KALITEXT000005680889&dateTexte=29990101&categorieLien=id"}],"expectedNotifications":[],"expectedFormula":{"formula":"1/10 * Sref","explanations":["Sref : Salaire de référence (3000 €)"]},"situation":{"contrat salarié . type de cdd":"'CDD d'animation commerciale'"}},
