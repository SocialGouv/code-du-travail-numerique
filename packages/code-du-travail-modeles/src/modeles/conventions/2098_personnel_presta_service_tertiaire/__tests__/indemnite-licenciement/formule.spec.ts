...
describe("Formule de l'indemnité de licenciement - CC 2098", () => {
  ...
  describe("Autre licenciement", () => {
    test.each`
      ...
      ${7}      | ${"(1/10 * Sref * A) + (1/7 * Sref * A2)"}                                                             | ${["A1: Années d'ancienneté à compter de la 1re année (5 ans)", "A2: Années d'ancienneté au-delà de la 5e année (2 ans)", "Sref : Salaire de référence (2800 €)"]}
      ${14}     | ${"(1/10 * Sref * A) + (1/7 * Sref * A2) + (1/5 * Sref * A3)"}                                         | ${["A1: Années d'ancienneté à compter de la 1re année (5 ans)", "A2: Années d'ancienneté au-delà de la 5e année (5 ans)", "A3: Années d'ancienneté au-delà de la 10e année (3 ans)", "Sref : Salaire de référence (2800 €)"]}
      ${26}     | ${"(1/10 * Sref * A) + (1/7 * Sref * A2) + (1/5 * Sref * A3) + (1/4 * Sref * A4)"}                     | ${["A1: Années d'ancienneté à compter de la 1re année (5 ans)", "A2: Années d'ancienneté au-delà de la 5e année (5 ans)", "A3: Années d'ancienneté au-delà de la 10e année (9 ans)", "A4: Années d'ancienneté au-delà de la 20e année (tranche de 5 ans)", "Sref : Salaire de référence (2800 €)"]}
      ${33}     | ${"(1/10 * Sref * A) + (1/7 * Sref * A2) + (1/5 * Sref * A3) + (1/4 * Sref * A4) + (1/3 * Sref * A5)"} | ${["A1: Années d'ancienneté à compter de la 1re année (5 ans)", "A2: Années d'ancienneté au-delà de la 5e année (5 ans)", "A3: Années d'ancienneté au-delà de la 10e année (9 ans)", "A4: Années d'ancienneté au-delà de la 20e année (tranche de 9 ans)", "A5: Années d'ancienneté au-delà de la 30e année (3 ans)", "Sref : Salaire de référence (2800 €)"]}
    `(
    ...
    test.each`
      ...
      ${14}     | ${35} | ${"(3/10 * Sref * A1) + (4/10 * Sref * A2) + (5/10 * Sref * A3)"}                      | ${["A1: Années d'ancienneté à compter de la 1re année (5 ans)", "A2: Années d'ancienneté au-delà de la 5e année (4 ans)", "A3: Années d'ancienneté au-delà de la 10e année (tranche de 3 ans)", "Sref : Salaire de référence (2800 €)"]}
      ${22}     | ${35} | ${"(3/10 * Sref * A1) + (4/10 * Sref * A2) + (5/10 * Sref * A3) + (6/10 * Sref * A4)"} | ${["A1: Années d'ancienneté à compter de la 1re année (5 ans)", "A2: Années d'ancienneté au-delà de la 5e année (4 ans)", "A3: Années d'ancienneté au-delà de la 10e année (tranche de 4 ans)", "A4: Années d'ancienneté au-delà de la 15e année (7 ans)", "Sref : Salaire de référence (2800 €)"]}
      ...
      ${14}     | ${54} | ${"(3/10 * Sref * A1) + (4/10 * Sref * A2) + (5/10 * Sref * A3)"}                      | ${["A1: Années d'ancienneté à compter de la 1re année (5 ans)", "A2: Années d'ancienneté au-delà de la 5e année (4 ans)", "A3: Années d'ancienneté au-delà de la 10e année (tranche de 3 ans)", "Sref : Salaire de référence (2800 €)"]}
