...
describe("Formule indemnité licenciement - CC 2148", () => {
  test.each`
    ...
    ${10}      | ${50} | ${"(3% * Sref * A1) + (4% * Sref * A2) + (5% * Sref)"}  | ${["A1 : Année complète d'ancienneté, décomptée à partir de la date d'entrée dans l'entreprise et jusqu'à 9 ans d'ancienneté révolus (9 ans)", "A2 : Année entière d'ancienneté pour la tranche comprise entre 10 et 25 ans révolus (1 an)", "Sref : Salaire de référence (1000 €)"]}
