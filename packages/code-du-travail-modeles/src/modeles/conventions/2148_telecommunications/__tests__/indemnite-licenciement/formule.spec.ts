...
describe("Formule indemnité licenciement - CC 2148", () => {
  test.each`
    ...
    ${1}      | ${38} | ${""}                                                   | ${[]}
    ${9}      | ${38} | ${"(3% * Sref * A1) + (4% * Sref * A2)"}                | ${["A1: Année complète d'ancienneté, décomptée à partir de la date d'entrée dans l'entreprise et jusqu'à 9 ans d'ancienneté révolus (9 ans)", "Sref : Salaire de référence (1000 €)"]}
    ...
    ${1}      | ${50} | ${""}                                                   | ${[]}
    ${9}      | ${50} | ${"(3% * Sref * A1) + (4% * Sref * A2)"}                | ${["A1: Année complète d'ancienneté, décomptée à partir de la date d'entrée dans l'entreprise et jusqu'à 9 ans d'ancienneté révolus (9 ans)", "Sref : Salaire de référence (1000 €)"]}
