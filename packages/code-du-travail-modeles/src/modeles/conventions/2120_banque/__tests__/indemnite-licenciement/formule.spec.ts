...
describe("Formule indemnité licenciement pour la CC 2120", () => {
  test.each`
    ...
    ${"01/01/1999"} | ${"Non-cadres"} | ${1200}            | ${1200}            | ${QuestionOuiNon.non} | ${QuestionOuiNon.non}     | ${1200}        | ${1200}   | ${2772} | ${"18 * 13 / 14.5 * Sref"}                             | ${["Sref : Salaire de référence (2772 €)"]}
    ${"01/01/1999"} | ${"Cadres"}     | ${1200}            | ${1200}            | ${QuestionOuiNon.non} | ${QuestionOuiNon.non}     | ${1200}        | ${1200}   | ${2772} | ${"24 * 13 / 14.5 * Sref"}                             | ${["Sref : Salaire de référence (2772 €)"]}
  `(
