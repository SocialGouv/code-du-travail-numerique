...
describe("Formule indemnité licenciement pour la CC 2120", () => {
  test.each`
    ...
    ${"01/01/1999"} | ${"Non-cadres"} | ${2}               | ${0}               | ${QuestionOuiNon.oui} | ${undefined}              | ${1}           | ${1}      | ${1991} | ${"(1/2 * Sref * A1)"}                                 | ${["A1: Semestres complets d'ancienneté acquis dans l'entreprise antérieurement au 1er janvier 2002 (2 semestres)", "Sref : Salaire de référence (1991 €)"]}
    ...
    ${"01/01/1999"} | ${"Cadres"}     | ${2}               | ${0}               | ${QuestionOuiNon.oui} | ${undefined}              | ${1}           | ${1}      | ${3064} | ${"(1/2 * Sref * A1)"}                                 | ${["A1: Semestres complets d'ancienneté acquis dans l'entreprise antérieurement au 1er janvier 2002 (2 semestres)", "Sref : Salaire de référence (3064 €)"]}
    ...
    ${"01/01/2000"} | ${"Non-cadres"} | ${2}               | ${0}               | ${QuestionOuiNon.oui} | ${undefined}              | ${1}           | ${1}      | ${1991} | ${"(1/2 * Sref * A1)"}                                 | ${["A1: Semestres complets d'ancienneté acquis dans l'entreprise antérieurement au 1er janvier 2002 (2 semestres)", "Sref : Salaire de référence (1991 €)"]}
    ...
    ${"01/01/1999"} | ${"Non-cadres"} | ${2}               | ${0}               | ${QuestionOuiNon.non} | ${QuestionOuiNon.non}     | ${1}           | ${1}      | ${2772} | ${"(1/2 * (13/14,5) * Sref * A1)"}                     | ${["A1: Semestres complets d'ancienneté acquis dans l'entreprise antérieurement au 1er janvier 2002 (2 semestres)", "Sref : Salaire de référence (2772 €)"]}
    ...
    ${"01/01/1999"} | ${"Cadres"}     | ${2}               | ${0}               | ${QuestionOuiNon.non} | ${QuestionOuiNon.non}     | ${1}           | ${1}      | ${2772} | ${"(1/2 * (13/14,5) * Sref * A1)"}                     | ${["A1: Semestres complets d'ancienneté acquis dans l'entreprise antérieurement au 1er janvier 2002 (2 semestres)", "Sref : Salaire de référence (2772 €)"]}
