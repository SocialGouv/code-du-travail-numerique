...
describe("Indemnité conventionnel de licenciement pour la CC 2120", () => {
  describe("Sans inaptitude", () => {
    test.each`
      ...
      ${"01/01/2020"} | ${"Cadres"}     | ${0}               | ${6}               | ${QuestionOuiNon.non} | ${QuestionOuiNon.non}     | ${3}           | ${3}      | ${3000} | ${3600}
    `(
  ...
  describe("Avec inaptitude", () => {
    test.each`
      ...
      ${"01/01/2020"} | ${"Cadres"}     | ${0}               | ${6}               | ${3}           | ${3}      | ${3000} | ${3600}
    `(
