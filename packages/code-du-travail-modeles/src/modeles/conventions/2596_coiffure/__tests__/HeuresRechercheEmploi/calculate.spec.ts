  ...
  test.each([
    {
      ...
      expectedReferences: [
        {
          article: "Article 7.4.4",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=66A29F5D26CA9B3AB9D6CF5888110E5B.tplgfr30s_3?idArticle=KALIARTI000018563850&cidTexte=KALITEXT000018563760&dateTexte=29990101&categorieLien=id",
        },
      ],
    ...
    },
    {
      ...
      expectedReferences: [
        {
          article: "Article 7.3",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=40918918FC583E87EE1E942DFFF9D936.tplgfr30s_3?idArticle=KALIARTI000021023369&cidTexte=KALITEXT000018563760&dateTexte=29981231&categorieLien=id",
        },
      ],
      expectedNotifications: [],
      situation: {
