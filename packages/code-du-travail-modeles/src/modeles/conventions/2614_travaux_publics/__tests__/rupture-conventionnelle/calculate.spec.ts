...
describe("Calcul de l'indemnité de rupture conventionnelle pour la CC 2614", () => {
  describe("Vérifier qu'il N'y a pas d'ancienneté conventionnelle requise", () => {
    test("Cas de base", () => {
      const result = engine.calculate({
        ...
        "contrat salarié . convention collective . travaux publics . rupture conventionnelle . age":
          "50",
