...
describe("Formule indemnité licenciement - 1501", () => {
  describe("Autres licenciements", () => {
    test.each`
      ...
      ${"Non-cadres"} | ${1}       | ${""}                                                                                  | ${[]}
      ${"Non-cadres"} | ${2}       | ${"1/10 * Sref * A"}                                                                   | ${["A : Ancienneté totale (2 ans)", "Sref : Salaire de référence (2300 €)"]}
  ...
  describe("Licenciement économique", () => {
    test.each`
      ...
      ${"Non-cadres"} | ${49} | ${7}      | ${"1/10 * Sref * A"}                                                                                                                                                                 | ${["A : Ancienneté totale (7 ans)", "Sref : Salaire de référence (2300 €)"]}
      ${"Non-cadres"} | ${49} | ${13}     | ${"(1/10 * Sref * A1) + (1/15 * Sref * A2)"}                                                                                                                                         | ${["A1 : Ancienneté totale (13 ans)", "A2: Années d'ancienneté au-delà de 10 ans (3 ans)", "Sref : Salaire de référence (2300 €)"]}
      ${"Non-cadres"} | ${49} | ${16}     | ${"(1/10 * Sref * A1) + (2/15 * Sref * A2)"}                                                                                                                                         | ${["A1 : Ancienneté totale (16 ans)", "A2: Années d'ancienneté au-delà de 10 ans (6 ans)", "Sref : Salaire de référence (2300 €)"]}
      ...
      ${"Cadres"}     | ${50} | ${5}      | ${"1/10 * Sref * A"}                                                                                                                                                                 | ${["A : Ancienneté totale (5 ans)", "Sref : Salaire de référence (2300 €)"]}
      ${"Cadres"}     | ${50} | ${10}     | ${"(2/10 * Sref * A1) + (1/15 * Sref * A2) + (15% * ((2/10 * Sref * A1) + (1/15 * Sref * A2)))"}                                                                                     | ${["A1 : Années de présence au total (10 ans)", "A2 : Années au dessus de 5 ans jusqu'à 10 ans (5 ans)", "Sref : Salaire de référence (2300 €)"]}
      ${"Cadres"}     | ${50} | ${12}     | ${"(2/10 * Sref * A1) + (1/15 * Sref * A2) + (2/15 * Sref * A3) + (15% * ((2/10 * Sref * A1) + (1/15 * Sref * A2) + (2/15 * Sref * A3)))"}                                           | ${["A1 : Années de présence au total (12 ans)", "A2 : Années au dessus de 5 ans jusqu'à 10 ans (5 ans)", "A3 : Années au dessus de 10 ans jusqu'à 15 ans (2 ans)", "Sref : Salaire de référence (2300 €)"]}
      ${"Cadres"}     | ${50} | ${23}     | ${"(2/10 * Sref * A1) + (1/15 * Sref * A2) + (2/15 * Sref * A3) + (3/15 * Sref * A4) + (15% * ((2/10 * Sref * A1) + (1/15 * Sref * A2) + (2/15 * Sref * A3) + (3/15 * Sref * A4)))"} | ${["A1 : Années de présence au total (23 ans)", "A2 : Années au dessus de 5 ans jusqu'à 10 ans (5 ans)", "A3 : Années au dessus de 10 ans jusqu'à 15 ans (5 ans)", "A4 : Années au dessus de 15 ans (8 ans)", "Sref : Salaire de référence (2300 €)"]}
    `(
