  ...
  test.each([
    {
      ...
      expectedReferences: [
        {
          article: "Article 12",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=ADBA13D26C014861AB857E6C4FAE5204.tplgfr42s_2?idArticle=KALIARTI000005833465&cidTexte=KALITEXT000005672325&dateTexte=29990101&categorieLien=id",
        },
      ],
    ...
    },
    {
      ...
      situation: {
        "contrat salarié . convention collective . restauration rapide . catégorie professionnelle":
          "'Ouvriers, Employés'",
        "contrat salarié . convention collective . restauration rapide . catégorie professionnelle Ouvriers, Employés . ancienneté":
          "'Moins de 6 mois'",
      },
    },
    {
