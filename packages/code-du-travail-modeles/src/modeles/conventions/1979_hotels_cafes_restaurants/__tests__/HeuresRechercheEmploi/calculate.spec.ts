  ...
  test.each([
      ...
      expectedReferences: [
        {
          ...
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=0A4CDB15908BFF8D4A2E83C3B7A96545.tplgfr33s_2?idArticle=KALIARTI000005826296&cidTexte=KALITEXT000005670044&dateTexte=29990101&categorieLien=id",
        },
      ],
      expectedNotifications: [],
      situation: {
        "contrat salarié . convention collective . hotels cafes restaurants . typeRupture":
          "'Démission'",
      },
    },
    {
      expectedResult: {
        expectedValue:
          "2 heures par jour, dans la limite d'un nombre d'heures total équivalent au maximum à la durée hebdomadaire de travail du salarié. Le salarié n'a pas droit à ces heures de recherche d'emploi en cas de licenciement pour faute grave ou faute lourde",
        unit: "",
      },
      expectedReferences: [
        {
    ...
    },
    {
      ...
      expectedReferences: [
        {
          article: "Article 13",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=C33CCCA8A4BDBD476BF7D99A55F73BA4.tplgfr33s_2?idArticle=KALIARTI000005826269&cidTexte=KALITEXT000005670044&dateTexte=29990101&categorieLien=id",
        },
      ],
      expectedNotifications: [],
      situation: {
