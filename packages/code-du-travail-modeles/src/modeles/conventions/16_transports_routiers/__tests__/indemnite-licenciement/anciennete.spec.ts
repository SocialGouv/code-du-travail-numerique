...
describe("CC 16", () => {
  ...
  describe("Calcul de l'ancienneté pour un cadre", () => {
    test.each`
      ...
      ${[{ durationInMonth: "1", motif: { key: MotifKeys.congesSansSolde, value: 1 }, startedAt: "01/05/2020" }]}                                                                                                                                                                                                                                                                                                                                                                                                                                                | ${"01/01/2020"} | ${"01/01/2022"} | ${"01/01/2021"}   | ${1}               | ${{ "contrat salarié . convention collective . transports routiers . indemnité de licenciement . catégorie professionnelle . Ingénieurs et cadres . ancienneté avant cadre": 1 - 1 / 12 }}
      ${[{ durationInMonth: "1", motif: { key: MotifKeys.congesSansSolde, value: 1 }, startedAt: "01/05/2021" }]}                                                                                                                                                                                                                                                                                                                                                                                                                                                | ${"01/01/2020"} | ${"01/01/2022"} | ${"01/01/2021"}   | ${1 - 1 / 12}      | ${{ "contrat salarié . convention collective . transports routiers . indemnité de licenciement . catégorie professionnelle . Ingénieurs et cadres . ancienneté avant cadre": 1 }}
