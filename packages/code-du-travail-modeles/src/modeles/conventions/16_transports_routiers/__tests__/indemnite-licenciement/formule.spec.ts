...
describe("Formule indemnité licenciement - CC 16", () => {
  ...
  describe("Pour un Ingénieur et Cadre", () => {
    test.each`
      ...
      ${5}      | ${0}         | ${false}   | ${60} | ${true}               | ${"4 / 10 * Sref * A1"}                                                                                                      | ${["A1 : Ancienneté totale (5 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${5}      | ${0}         | ${false}   | ${61} | ${true}               | ${"(4 / 10 * Sref * A1) - (20% * A3 * (4 / 10 * Sref * A1))"}                                                                | ${["A1 : Ancienneté totale (5 ans)", "A3 : Années entre 60 et 65 ans (1 an)", "Sref : Salaire de référence (1000 €)"]}
      ${5}      | ${0}         | ${false}   | ${63} | ${true}               | ${"(4 / 10 * Sref * A1) - (20% * A3 * (4 / 10 * Sref * A1))"}                                                                | ${["A1 : Ancienneté totale (5 ans)", "A3 : Années entre 60 et 65 ans (3 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${20}     | ${0}         | ${false}   | ${61} | ${true}               | ${"(4 / 10 * Sref * A1) - (20% * A3 * (4 / 10 * Sref * A1)) + (2 * Sref)"}                                                   | ${["A1 : Ancienneté totale (20 ans)", "A3 : Années entre 60 et 65 ans (1 an)", "Sref : Salaire de référence (1000 €)"]}
      ${35}     | ${0}         | ${false}   | ${61} | ${true}               | ${"(4 / 10 * Sref * A1) - (20% * A3 * (4 / 10 * Sref * A1)) + (4 * Sref)"}                                                   | ${["A1 : Ancienneté totale (35 ans)", "A3 : Années entre 60 et 65 ans (1 an)", "Sref : Salaire de référence (1000 €)"]}
