...
describe("Formule indemnité licenciement - 44", () => {
  test.each`
    ...
    ${CategoryPro44.ouvrier}     | ${false}         | ${50} | ${5}      | ${"Sref + 3 / 10 * Sref * A"}                                                | ${["Sref : Salaire de référence (1000 €)", "A : Année d'ancienneté à compter de la date d'entrée dans l'entreprise (5 ans)"]}
    ...
    ${CategoryPro44.ouvrier}     | ${false}         | ${55} | ${5}      | ${"2 * Sref + 3 / 10 * Sref * A"}                                            | ${["Sref : Salaire de référence (1000 €)", "A : Année d'ancienneté à compter de la date d'entrée dans l'entreprise (5 ans)"]}
    ...
    ${CategoryPro44.ouvrier}     | ${false}         | ${57} | ${5}      | ${"2 * Sref + 3 / 10 * Sref * A"}                                            | ${["Sref : Salaire de référence (1000 €)", "A : Année d'ancienneté à compter de la date d'entrée dans l'entreprise (5 ans)"]}
    ${CategoryPro44.techniciens} | ${false}         | ${50} | ${1.33}   | ${""}                                                                        | ${[]}
    ${CategoryPro44.techniciens} | ${false}         | ${50} | ${1.99}   | ${""}                                                                        | ${[]}
    ${CategoryPro44.techniciens} | ${false}         | ${50} | ${2}      | ${"3 / 10 * Sref * A1"}                                                      | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (2 ans)"]}
    ...
    ${CategoryPro44.techniciens} | ${false}         | ${50} | ${5}      | ${"Sref + 3 / 10 * Sref * A1"}                                               | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (5 ans)"]}
    ${CategoryPro44.techniciens} | ${false}         | ${50} | ${10}     | ${"Sref + 3 / 10 * Sref * A1 + 1 / 10 * Sref * A2"}                          | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (10 ans)", "A2 : A partir de 10 ans d'ancienneté : Années passées dans l'entreprise à compter de la date d'entrée (10 ans)"]}
    ${CategoryPro44.techniciens} | ${false}         | ${50} | ${20}     | ${"Sref + 3 / 10 * Sref * A1 + 1 / 10 * Sref * A2 + 1 / 10 * Sref * A3"}     | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (20 ans)", "A2 : A partir de 10 ans d'ancienneté : Années passées dans l'entreprise à compter de la date d'entrée (20 ans)", "A3 : A partir de 20 ans d'ancienneté : Années passées dans l'entreprise à compter de la date d'entrée (20 ans)"]}
    ${CategoryPro44.techniciens} | ${false}         | ${55} | ${1.33}   | ${""}                                                                        | ${[]}
    ${CategoryPro44.techniciens} | ${false}         | ${55} | ${1.99}   | ${""}                                                                        | ${[]}
    ${CategoryPro44.techniciens} | ${false}         | ${55} | ${2}      | ${"3 / 10 * Sref * A1"}                                                      | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (2 ans)"]}
    ...
    ${CategoryPro44.techniciens} | ${false}         | ${55} | ${5}      | ${"2 * Sref + 3 / 10 * Sref * A1"}                                           | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (5 ans)"]}
    ${CategoryPro44.techniciens} | ${false}         | ${55} | ${10}     | ${"2 * Sref + 3 / 10 * Sref * A1 + 1 / 10 * Sref * A2"}                      | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (10 ans)", "A2 : A partir de 10 ans d'ancienneté : Années passées dans l'entreprise à compter de la date d'entrée (10 ans)"]}
    ${CategoryPro44.techniciens} | ${false}         | ${55} | ${20}     | ${"2 * Sref + 3 / 10 * Sref * A1 + 1 / 10 * Sref * A2 + 1 / 10 * Sref * A3"} | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (20 ans)", "A2 : A partir de 10 ans d'ancienneté : Années passées dans l'entreprise à compter de la date d'entrée (20 ans)", "A3 : A partir de 20 ans d'ancienneté : Années passées dans l'entreprise à compter de la date d'entrée (20 ans)"]}
    ${CategoryPro44.techniciens} | ${false}         | ${56} | ${1.33}   | ${""}                                                                        | ${[]}
    ${CategoryPro44.techniciens} | ${false}         | ${56} | ${1.99}   | ${""}                                                                        | ${[]}
    ${CategoryPro44.techniciens} | ${false}         | ${56} | ${2}      | ${"3 / 10 * Sref * A1"}                                                      | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (2 ans)"]}
    ...
    ${CategoryPro44.inge}        | ${false}         | ${40} | ${2}      | ${"4 / 10 * Sref * A1"}                                                      | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (2 ans)"]}
    ...
    ${CategoryPro44.inge}        | ${false}         | ${48} | ${2}      | ${"4 / 10 * Sref * A1"}                                                      | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (2 ans)"]}
    ...
    ${CategoryPro44.inge}        | ${false}         | ${58} | ${2}      | ${"4 / 10 * Sref * A1"}                                                      | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (2 ans)"]}
    ...
    ${CategoryPro44.ouvrier}     | ${true}          | ${52} | ${5}      | ${"2 * Sref + 3 / 10 * Sref * A"}                                            | ${["Sref : Salaire de référence (1000 €)", "A : Année d'ancienneté à compter de la date d'entrée dans l'entreprise (5 ans)"]}
    ...
    ${CategoryPro44.ouvrier}     | ${true}          | ${56} | ${5}      | ${"2 * Sref + 3 / 10 * Sref * A"}                                            | ${["Sref : Salaire de référence (1000 €)", "A : Année d'ancienneté à compter de la date d'entrée dans l'entreprise (5 ans)"]}
    ...
    ${CategoryPro44.techniciens} | ${true}          | ${56} | ${5}      | ${"2 * Sref + 3 / 10 * Sref * A1"}                                           | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise (5 ans)"]}
    ...
    ${CategoryPro44.inge}        | ${true}          | ${56} | ${5}      | ${"2 * Sref + 4 / 10 * Sref * A1"}                                           | ${["Sref : Salaire de référence (1000 €)", "A1 : Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (5 ans)"]}
  `(
