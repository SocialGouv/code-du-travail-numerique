  ...
  describe("Licenciement normal", () => {
    ...
    describe("Technicien", () => {
      test.each`
        ...
        ${CategoryPro44.techniciens} | ${false}         | ${50} | ${5}      | ${"Sref + 3 / 10 * Sref * A1"}                                               | ${["A1 : Années à compter de la date d'entrée dans l'entreprise (5 ans)"]}
    ...
    describe("Ingénieur", () => {
      test.each`
        ...
        ${CategoryPro44.inge} | ${false}         | ${48} | ${5}      | ${"Sref + 4 / 10 * Sref * A1"}                                               | ${["A1 : Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (5 ans)", "Sref : Salaire de référence (1000 €)"]}
        ...
        ${CategoryPro44.inge} | ${false}         | ${58} | ${2}      | ${"4 / 10 * Sref * A1"}                                                      | ${["A1 : Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (2 ans)"]}
        ${CategoryPro44.inge} | ${false}         | ${58} | ${2.5}    | ${"4 / 10 * Sref * A1"}                                                      | ${["A1 : Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (2.5 ans)"]}
        ${CategoryPro44.inge} | ${false}         | ${58} | ${5}      | ${"2 * Sref + 4 / 10 * Sref * A1"}                                           | ${["A1 : Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (5 ans)"]}
        ${CategoryPro44.inge} | ${false}         | ${58} | ${10}     | ${"2 * Sref + 4 / 10 * Sref * A1"}                                           | ${["A1 : Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (10 ans)"]}
        ${CategoryPro44.inge} | ${false}         | ${58} | ${13}     | ${"2 * Sref + 4 / 10 * Sref * A1 + 6 / 10 * Sref * A2"}                      | ${["A1 : Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (10 ans)", "A2 : Années au-delà de 10 ans pour la tranche de 10 à 15 ans (3 ans)"]}
        ${CategoryPro44.inge} | ${false}         | ${58} | ${17}     | ${"2 * Sref + 4 / 10 * Sref * A1 + 6 / 10 * Sref * A2 + 8 / 10 * Sref * A3"} | ${["A1 : Années à compter de la date d'entrée dans l'entreprise pour la tranche 0 à 10 ans (10 ans)", "A2 : Années au-delà de 10 ans pour la tranche de 10 à 15 ans (5 ans)", "A3 : Années au-delà de 15 ans (2 ans)"]}
      `(
        "$#) Avec $seniority ans, catégorie $category, age $age, isEconomicFiring $isEconomicFiring",
        ({
          category,
