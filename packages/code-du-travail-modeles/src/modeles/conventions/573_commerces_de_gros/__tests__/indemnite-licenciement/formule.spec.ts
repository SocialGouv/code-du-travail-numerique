...
describe("Formules pour la CC 573", () => {
  ...
  describe("Cadres", () => {
    test.each`
      ...
      ${32} | ${CatPro573.cadres} | ${QuestionOuiNon.non} | ${QuestionOuiNon.oui} | ${1}      | ${"2 / 10 * Sref * A"}                                                                                                                   | ${["A1 : Années d'ancienneté au total (1 an)", "Sref : Salaire de référence (1000 €)"]}
      ${32} | ${CatPro573.cadres} | ${QuestionOuiNon.non} | ${QuestionOuiNon.oui} | ${4}      | ${"2 / 10 * Sref * A"}                                                                                                                   | ${["A1 : Années d'ancienneté au total (4 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${32} | ${CatPro573.cadres} | ${QuestionOuiNon.non} | ${QuestionOuiNon.oui} | ${5}      | ${"2 / 10 * Sref * A"}                                                                                                                   | ${["A1 : Années d'ancienneté au total (5 ans)", "Sref : Salaire de référence (1000 €)"]}
