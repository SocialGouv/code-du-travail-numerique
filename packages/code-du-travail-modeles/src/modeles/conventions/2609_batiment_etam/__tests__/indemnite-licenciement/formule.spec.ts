...
describe("Indemnité légale de licenciement avec une formule personnalisée et expliquée pour la CC 2609", () => {
  ...
  test.each`
    ...
    ${2}       | ${50} | ${""}                                                                                                              | ${[]}
    ${25 / 12} | ${50} | ${"2.5 / 10 * Sref * A"}                                                                                           | ${["A : Ancienneté totale (2.08 ans)", "Sref : Salaire de référence (1000 €)"]}
    ...
    ${2}       | ${58} | ${""}                                                                                                              | ${[]}
    ${25 / 12} | ${58} | ${"(2.5 / 10 * Sref * A) + (10% * (2.5 / 10 * Sref * A))"}                                                         | ${["A : Ancienneté totale (2.08 ans)", "Sref : Salaire de référence (1000 €)"]}
    ...
    ${2}       | ${66} | ${""}                                                                                                              | ${[]}
    ${25 / 12} | ${66} | ${"1.5 / 10 * Sref * A"}                                                                                           | ${["A : Ancienneté totale (2.08 ans)", "Sref : Salaire de référence (1000 €)"]}
