...
describe("Indemnité conventionnel de licenciement pour la CC 2216", () => {
  describe("Cas standard", () => {
    test.each`
      ...
      ${"Employés et ouvriers, personnel de livraison"} | ${false}         | ${50} | ${7 / 12} | ${2000} | ${0}
      ...
      ${"Employés et ouvriers, personnel de livraison"} | ${false}         | ${45} | ${7 / 12} | ${2500} | ${0}
