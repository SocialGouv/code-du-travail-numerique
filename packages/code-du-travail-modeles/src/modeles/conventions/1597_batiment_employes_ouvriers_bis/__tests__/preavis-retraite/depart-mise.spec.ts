...
const CommonReference = {
  ...
  url: "https://www.legifrance.gouv.fr/conv_coll/article/KALIARTI000005807765#KALIARTI000005807765",
};
...
describe("Vérification des départs à la retraite, mise à la retraite et des références juridiques de la convention collective 1597", () => {
  test.each`
