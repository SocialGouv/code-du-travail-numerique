    ...
    describe("Non-cadres", () => {
      test.each([
        ...
        },
        {
          ...
          expectedFormula: "(1/4 * Sref * A1) + (1/4 * Sref * A2)",
          seniority: 10,
        },
        {
          expectedExplanations: [
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (1/4 * Sref * A2) + (3/5 * Sref * A3)",
          seniority: 15,
        },
        {
          expectedExplanations: [
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (1/4 * Sref * A2) + (3/5 * Sref * A3) + (4/5 * Sref * A4)",
          seniority: 20,
        },
        {
          expectedExplanations: [
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (1/4 * Sref * A2) + (3/5 * Sref * A3) + (4/5 * Sref * A4) + (1 * Sref * A5)",
          seniority: 25,
        },
        {
          expectedExplanations: ["Sref : Salaire de référence (5000 €)"],
    ...
    describe("Cadres", () => {
      test.each([
        ...
        },
        {
          ...
          expectedFormula: "(1/4 * Sref * A1) + (1/4 * Sref * A2) + (1 * Sref)",
          seniority: 10,
        },
        {
          age: 50,
        ...
        },
        {
          ...
          expectedFormula: "(1/4 * Sref * A1) + (1/4 * Sref * A2) + (2 * Sref)",
          seniority: 10,
        },
        {
          age: 56,
        ...
        },
        {
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (1/4 * Sref * A2) + (4/5 * Sref * A3)",
          seniority: 15,
        },
        {
          age: 50,
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (1/4 * Sref * A2) + (4/5 * Sref * A3) + (1 * Sref)",
          seniority: 15,
        },
        {
          age: 56,
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (1/4 * Sref * A2) + (4/5 * Sref * A3) + (2 * Sref)",
          seniority: 15,
        },
        {
          age: 45,
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (1/4 * Sref * A2) + (4/5 * Sref * A3) + (1 * Sref * A4)",
          seniority: 20,
        },
        {
          age: 50,
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (1/4 * Sref * A2) + (4/5 * Sref * A3) + (1 * Sref * A4) + (1 * Sref)",
          seniority: 20,
        },
        {
          age: 56,
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (1/4 * Sref * A2) + (4/5 * Sref * A3) + (1 * Sref * A4) + (2 * Sref)",
          seniority: 20,
        },
      ])(
        "Formule $expectedFormula avec une ancienneté de $seniority ans et age de $age ans",
    ...
    describe("Non-cadres", () => {
      test.each([
        ...
        },
        {
          ...
          expectedFormula: "(1/4 * Sref * A1) + (2/5 * Sref * A2)",
          seniority: 10,
        },
        {
          expectedExplanations: [
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (2/5 * Sref * A2) + (3/5 * Sref * A3)",
          seniority: 15,
        },
        {
          expectedExplanations: [
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (2/5 * Sref * A2) + (3/5 * Sref * A3) + (4/5 * Sref * A4)",
          seniority: 20,
        },
        {
          expectedExplanations: [
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (2/5 * Sref * A2) + (3/5 * Sref * A3) + (4/5 * Sref * A4) + (1 * Sref * A5)",
          seniority: 25,
        },
        {
          expectedExplanations: ["Sref : Salaire de référence (5000 €)"],
    ...
    describe("Cadres", () => {
      test.each([
        ...
        },
        {
          ...
          expectedFormula: "(1/4 * Sref * A1) + (2/5 * Sref * A2) + (1 * Sref)",
          seniority: 10,
        },
        {
          age: 50,
        ...
        },
        {
          ...
          expectedFormula: "(1/4 * Sref * A1) + (2/5 * Sref * A2) + (2 * Sref)",
          seniority: 10,
        },
        {
          age: 56,
        ...
        },
        {
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (2/5 * Sref * A2) + (4/5 * Sref * A3)",
          seniority: 15,
        },
        {
          age: 50,
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (2/5 * Sref * A2) + (4/5 * Sref * A3) + (1 * Sref)",
          seniority: 15,
        },
        {
          age: 56,
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (2/5 * Sref * A2) + (4/5 * Sref * A3) + (2 * Sref)",
          seniority: 15,
        },
        {
          age: 45,
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (2/5 * Sref * A2) + (4/5 * Sref * A3) + (1 * Sref * A4)",
          seniority: 20,
        },
        {
          age: 50,
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (2/5 * Sref * A2) + (4/5 * Sref * A3) + (1 * Sref * A4) + (1 * Sref)",
          seniority: 20,
        },
        {
          age: 56,
          ...
          expectedFormula:
            "(1/4 * Sref * A1) + (2/5 * Sref * A2) + (4/5 * Sref * A3) + (1 * Sref * A4) + (2 * Sref)",
          seniority: 20,
        },
      ])(
        "Formule $expectedFormula avec une ancienneté de $seniority ans et age de $age ans",
