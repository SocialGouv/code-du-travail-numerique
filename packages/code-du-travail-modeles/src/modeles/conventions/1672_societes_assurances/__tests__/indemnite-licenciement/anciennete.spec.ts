...
describe("Calcul de l'ancienneté : CC 1672", () => {
  ...
  describe("Cadre", () => {
    test.each`
      ...
      ${[{ durationInMonth: "24", motif: { key: MotifKeys.congesParentalEducation }, startedAt: "01/05/2021" }]} | ${"01/01/2020"} | ${"01/01/2024"} | ${"01/01/2021"}   | ${2}               | ${{ "contrat salarié . convention collective . sociétés d'assurances . catégorie professionnelle . cadres . ancienneté non cadre": 1 }}
      ${[{ durationInMonth: "1", motif: { key: MotifKeys.congesSansSolde }, startedAt: "01/05/2021" }]}          | ${"01/01/2020"} | ${"01/01/2022"} | ${"01/01/2021"}   | ${1 - 1 / 12}      | ${{ "contrat salarié . convention collective . sociétés d'assurances . catégorie professionnelle . cadres . ancienneté non cadre": 1 }}
      ${[{ durationInMonth: "12", motif: { key: MotifKeys.congesParentalEducation }, startedAt: "01/05/2021" }]} | ${"01/01/2020"} | ${"01/01/2022"} | ${"01/01/2021"}   | ${1}               | ${{ "contrat salarié . convention collective . sociétés d'assurances . catégorie professionnelle . cadres . ancienneté non cadre": 1 }}
