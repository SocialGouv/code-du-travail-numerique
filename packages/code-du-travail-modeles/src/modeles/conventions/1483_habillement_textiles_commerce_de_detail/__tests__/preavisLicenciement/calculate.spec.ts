  ...
  test.each([
    {
      ...
      expectedReferences: [
        {
          article: "Article 9, chapitre II",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=A8279343D320ACDCBDFC588C32FB25B3.tplgfr22s_1?idArticle=KALIARTI000005840302&cidTexte=KALITEXT000005675211&dateTexte=29990101&categorieLien=id",
        },
      ],
    ...
    },
    {
      ...
      expectedReferences: [
        {
          article: "Article 15, chapitre I",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=A8279343D320ACDCBDFC588C32FB25B3.tplgfr22s_1?idArticle=KALIARTI000005840261&cidTexte=KALITEXT000005675211&dateTexte=29990101&categorieLien=id",
        },
      ],
      expectedNotifications: [],
      situation: {
