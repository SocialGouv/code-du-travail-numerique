...
describe("Test de la fonctionnalité 'calculate'", () => {
  test.each([
      ...
      expectedReferences: [
        {
          ...
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=E5B5B8F059E9188492430B0C2B630256.tplgfr29s_3?idArticle=KALIARTI000027034201&cidTexte=KALITEXT000026943196&dateTexte=29990101&categorieLien=id",
        },
      ],
    ...
    {
      expectedResult: { expectedValue: "4 heures par semaine", unit: "" },
      expectedReferences: [
        {
          article:
            "Article 1. 1 de la section 1 du Chapitre 4 de la Partie II de la convention collective",
      ...
      expectedReferences: [
        {
          ...
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=8F2D5914256C40BA951DD21EC1A2C521.tplgfr29s_3?idArticle=KALIARTI000026943300&cidTexte=KALITEXT000026943196&dateTexte=29990101&categorieLien=id",
        },
      ],
      expectedNotifications: [],
      situation: {
