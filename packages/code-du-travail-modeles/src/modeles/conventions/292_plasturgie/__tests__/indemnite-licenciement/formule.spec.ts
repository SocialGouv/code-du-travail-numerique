...
describe("Formule pour l'indemnité conventionnel de licenciement pour la CC 292", () => {
  describe("Cadres", () => {
    test.each`
      ...
      ${35}     | ${"3 / 10 * Sref * A1 + 4 / 10 * Sref * A2 + 5 / 10 * Sref * A3"} | ${["A1 : Années d'ancienneté pour la tranche depuis la date d'entrée jusqu'à la 8ème année incluse d'ancienneté (8 ans)", "A2 : Années d'ancienneté pour tranche du début de 9ème année jusqu'à la fin de la 13ème année d'ancienneté (5 ans)", "A3 : Années d'ancienneté au-delà de la 13ème année d'ancienneté (22 ans)", "Sref : Salaire de référence (2000 €)"]}
    `(
