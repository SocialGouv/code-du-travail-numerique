  ...
  test.each([
    {
      expectedResult: {
        expectedValue:
          "2 heures par jour travaillé ou 1 journée par semaine de travail. Pour le salarié à temps partiel, la durée de l’absence est calculée proportionnellement au temps de travail et est égale au minimum à 1 heure par semaine",
        unit: "",
      },
      expectedReferences: [
        {
      ...
      situation: {
        "contrat salarié . convention collective . bad . typeRupture":
          "'Démission'",
      },
    },
    {
      ...
      expectedNotifications: [
        "Le salaire est maintenu, sauf en cas de licenciement pour faute grave ou faute lourde.",
        "",
      ],
      situation: {
        "contrat salarié . convention collective . bad . typeRupture":
    ...
    },
    {
      ...
      expectedReferences: [
        {
          article: "Article 16",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do?idArticle=KALIARTI000025805623&cidTexte=KALITEXT000025805457&dateTexte=20100521",
        },
      ],
      expectedNotifications: [],
      situation: {
