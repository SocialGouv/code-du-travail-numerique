...
describe("CC 2941", () => {
  describe("Calcul de l'ancienneté", () => {
    test.each`
      ...
      ${[{ durationInMonth: 0.5, motif: { key: MotifKeys.maladieNonPro, value: 1 }, startedAt: "02/02/2011" }, { durationInMonth: 0.75, motif: { key: MotifKeys.maladieNonPro, value: 1 }, startedAt: "02/02/2013" }, { durationInMonth: 2.5, motif: { key: MotifKeys.maladieNonPro, value: 1 }, startedAt: "02/02/2017" }]}                                                                                                                                                                                                                                               | ${"01/01/2008"} | ${"01/01/2021"} | ${12.875}
      ${[{ durationInMonth: "2", motif: { key: MotifKeys.maladieNonPro, value: 1 }, startedAt: "01/08/2022" }]}                                                                                                                                                                                                                                                                                                                                                                                                                                                            | ${"01/01/2022"} | ${"01/02/2023"} | ${1}
    `(
      "Calcul de l'ancienneté avec $entryDate et $exitDate en attendant $expectedAnciennete an",
      ({ absences, entryDate, exitDate, expectedAnciennete }) => {
        const seniority = new SeniorityFactory().create(SupportedCc.IDCC2941);
