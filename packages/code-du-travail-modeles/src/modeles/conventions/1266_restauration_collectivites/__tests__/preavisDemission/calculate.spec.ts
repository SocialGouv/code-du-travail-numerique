...
const engine = new PreavisDemissionPublicodes(modelsPreavisDemission, "1266");
  ...
  test.each([
    ...
    },
    {
      ...
      situation: {
        "contrat salarié . convention collective . restauration collectivités . catégorie professionnelle":
          "'Employés'",
        "contrat salarié . convention collective . restauration collectivités . catégorie professionnelle Employés . ancienneté":
          "'Moins de 6 mois'",
      },
    },
    {
    ...
    },
    {
      ...
      situation: {
        "contrat salarié . convention collective . restauration collectivités . catégorie professionnelle":
          "'Maîtrises'",
        "contrat salarié . convention collective . restauration collectivités . catégorie professionnelle Maîtrises . ancienneté":
          "'Moins de 6 mois'",
      },
    },
    {
