...
describe("CC 1740", () => {
  describe("Formule indemnité licenciement", () => {
    test.each`
      ...
      ${1}           | ${1}      | ${55} | ${""}                                                                                                          | ${[]}
      ${1.99}        | ${2}      | ${55} | ${""}                                                                                                          | ${[]}
      ${2}           | ${2}      | ${55} | ${"(1 / 10 * Sref * A)"}                                                                                       | ${["A : Années d'ancienneté (2 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${2}           | ${5}      | ${55} | ${"(1 / 10 * Sref * A)"}                                                                                       | ${["A : Années d'ancienneté (5 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${2}           | ${8}      | ${55} | ${"(3 / 20 * Sref * A1)"}                                                                                      | ${["A1 : Années d'ancienneté depuis la première année dans l'entreprise (8 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${2}           | ${15}     | ${55} | ${"(3 / 20 * Sref * A1)"}                                                                                      | ${["A1 : Années d'ancienneté depuis la première année dans l'entreprise (15 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${2}           | ${26}     | ${55} | ${"(3 / 20 * Sref * A1) + (1 / 20 * Sref * A2)"}                                                               | ${["A1 : Années d'ancienneté depuis la première année dans l'entreprise (26 ans)", "A2 : Années d'ancienneté au delà de 15 ans (11 ans)", "Sref : Salaire de référence (1000 €)"]}
      ${1}           | ${1}      | ${59} | ${""}                                                                                                          | ${[]}
      ${1.99}        | ${2}      | ${59} | ${""}                                                                                                          | ${[]}
