...
describe("Formule indemnité licenciement - CC 3239", () => {
  ...
  test.each`
    ...
    ${CatPro3239.salarieParticulierEmployeur} | ${8 / 12} | ${"1/4 * Sref * A"}                        | ${["A : Ancienneté totale (~0.67 an: valeur arrondi)", "Sref : Salaire de référence (1000 €)"]}
    ...
    ${CatPro3239.assistantMaternel}           | ${8 / 12} | ${"1/4 * Sref * A"}                        | ${["A : Ancienneté totale (~0.67 an: valeur arrondi)", "Sref : Salaire de référence (1000 €)"]}
