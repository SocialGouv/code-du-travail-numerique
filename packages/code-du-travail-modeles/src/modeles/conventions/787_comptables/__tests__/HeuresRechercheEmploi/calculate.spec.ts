...
describe("Test de la fonctionnalité 'calculate'", () => {
  test.each([
    {
      expectedResult: {
        expectedValue: "2 heures par journée d'ouverture du cabinet",
        unit: "",
      },
      expectedReferences: [
        {
          article: "Article 6.2.2",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=182066BF8498AFCDBA859500C460D147.tplgfr41s_1?idArticle=KALIARTI000029786918&cidTexte=KALITEXT000005674852&dateTexte=29981231&categorieLien=id",
        },
      ],
      ...
      situation: {
        "contrat salarié . convention collective . comptables . typeRupture":
          "'Démission'",
        "contrat salarié . convention collective . comptables . typeRupture Démission . ancienneté":
          "'Au moins 5 ans'",
      },
    },
    {
