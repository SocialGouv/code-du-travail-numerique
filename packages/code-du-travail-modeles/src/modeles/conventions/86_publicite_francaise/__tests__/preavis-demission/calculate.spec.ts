  ...
  test.each([
    {
      ...
      expectedReferences: [
        {
          article: "Article 48",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do?idArticle=KALIARTI000005857333&cidTexte=KALITEXT000005682357",
        },
      ],
    ...
    },
    {
      ...
      expectedReferences: [
        {
          article: "Article 29",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=D95886BC7232B7E17E29C15F66690F00.tplgfr24s_2?idArticle=KALIARTI000005857303&cidTexte=KALITEXT000005682357&dateTexte=29990101&categorieLien=id",
        },
      ],
      expectedNotifications: [],
      situation: {
