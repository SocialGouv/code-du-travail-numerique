  ...
  test.each([
    {
      ...
      expectedReferences: [
        {
          article: "Article 32",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=35EAB16785909B4320F79BDE561E5E6A.tplgfr29s_2?idArticle=KALIARTI000005873153&cidTexte=KALITEXT000005688564&dateTexte=29990101&categorieLien=id",
        },
      ],
      expectedNotifications: [],
      situation: {
        "contrat salarié . convention collective . boulangerie patisserie . typeRupture":
          "'Démission'",
      },
    },
    {
    ...
    },
    {
      ...
      expectedReferences: [
        {
          article: "Article 17",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do?idArticle=KALIARTI000005873126&cidTexte=KALITEXT000005688564",
        },
      ],
      expectedNotifications: [],
      situation: {
