  ...
  test.each([
    {
      ...
      expectedReferences: [
        {
          article: "Article 6 de l'annexe : Statut du personnel d'encadrement",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do?idArticle=KALIARTI000038678849&cidTexte=KALITEXT000005688564&dateTexte=20190827",
        },
      ],
    ...
    },
    {
      ...
      expectedReferences: [
        {
          article: "Article 32 de la convention collective",
          url: "https://www.legifrance.gouv.fr/affichIDCCArticle.do;jsessionid=DD88109D2F553DCDAAF4B80768DD7546.tplgfr25s_1?idArticle=KALIARTI000005873153&cidTexte=KALITEXT000005688564&dateTexte=29990101&categorieLien=id",
        },
      ],
      expectedNotifications: [],
      situation: {
