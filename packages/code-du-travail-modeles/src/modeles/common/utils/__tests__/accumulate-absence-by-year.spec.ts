...
describe("Accumulation d'absence par année", () => {
  test.each`
    ...
    ${[{ durationInMonth: 1, motif: { value: 1 }, startedAt: "20/03/2021" }]}                                                                       | ${[{ begin: date2020, end: date2021LessOneDay }, { begin: date2021, end: exitIn2021 }]} | ${[{ totalAbsenceInMonth: 1, year: 2020 }, { totalAbsenceInMonth: 0, year: 2021 }]}
  `(
