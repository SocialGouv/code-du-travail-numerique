...
describe("Accumulation d'absence par année", () => {
  test.each`
    ...
    ${[{ durationInMonth: 1, motif: { value: 1 }, startedAt: "20/03/2021" }]}                                                                       | ${[{ begin: date2020, end: date2021LessOneDay }, { begin: date2021, end: exitIn2021 }]} | ${[{ totalAbsenceInMonth: 0.47433264887063653, year: 2020 }, { totalAbsenceInMonth: 0.459958932238193, year: 2021 }]}
  `(
