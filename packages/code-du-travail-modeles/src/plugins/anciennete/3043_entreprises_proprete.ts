...
export const MOTIFS_3043: Motif[] = [
  ...
  { key: "absenceCongesSabbatique", label: "Congé sabbatique", value: 0 },
  {
  ...
  { key: "absenceCongesSansSolde", label: "Congés sans solde", value: 0 },
  { key: "absenceGreve", label: "Grève", value: 0 },
  { key: "absenceMiseAPied", label: "Mise à pied", value: 0 },
