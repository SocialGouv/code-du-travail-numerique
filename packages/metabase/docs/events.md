...
Genere le **2026-04-23T15:09:23.042Z** depuis `packages/code-du-travail-frontend/src`.
...
- [Commandes Matomo de configuration](#commandes-matomo-de-configuration-non-events) (8)
...
| --- | --- | --- |
| `forgetCookieConsentGiven` | _(aucun)_ | `packages/code-du-travail-frontend/src/modules/utils/consent.ts:119` |
| `forgetUserOptOut` | _(aucun)_ | `packages/code-du-travail-frontend/src/modules/utils/consent.ts:115` |
| `HeatmapSessionRecording::disable` | _(aucun)_ | `packages/code-du-travail-frontend/src/modules/utils/consent.ts:100` |
| `HeatmapSessionRecording::enable` | _(aucun)_ | `packages/code-du-travail-frontend/src/modules/utils/consent.ts:98` |
| `optUserOut` | _(aucun)_ | `packages/code-du-travail-frontend/src/modules/utils/consent.ts:118` |
| `rememberCookieConsentGiven` | _(aucun)_ | `packages/code-du-travail-frontend/src/modules/utils/consent.ts:116` |
| `setCookieSameSite` | `None` | `packages/code-du-travail-frontend/src/modules/config/MatomoAnalytics.tsx:45` |
| `setReferrerUrl` | `<referrerUrl>` | `packages/code-du-travail-frontend/src/modules/config/MatomoAnalytics.tsx:41` |
