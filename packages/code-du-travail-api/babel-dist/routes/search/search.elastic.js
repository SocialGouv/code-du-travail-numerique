    ...
    query: {
      bool: {
        ...
        must: [
          {
            bool: {
              should: [
                ...
                { match: { "text.french_with_synonyms": { query: query } } },
              ],
            },
          },
        ...
        should: [
          ...
          { match_phrase: { "text.french": { boost: 1.5, query: query } } },
          { match: { "title.french_with_synonyms": { query: query } } },
          { match: { source: { boost: 1.2, query: SOURCES.CONTRIBUTIONS } } },
          { match: { source: { boost: 1.1, query: SOURCES.TOOLS } } },
          { match: { source: { boost: 1.1, query: SOURCES.LETTERS } } },
        ],
      },
    },
    size: size,
