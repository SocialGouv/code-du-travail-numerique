...
const getDocumentByUrlQuery = (url, _source = [
    "title",
    "source",
    "slug",
    "description",
...
async function updateDocumentsData(slugs) {
    ...
    try {
        ...
        data.push({
            ...
            description: "Retrouvez les questions-réponses les plus fréquentes organisées par thème et élaborées par le ministère du Travail concernant cette convention collective.",
            excludeFromSearch: false,
            id: "KALICONT000005635191",
            isPublished: true,
            longTitle: "Convention collective nationale du commerce et de la réparation de l'automobile, du cycle et du motocycle et des activités connexes, ainsi que du contrôle technique automobile du 15 janvier 1981. Etendue par arrêté du 30 octobre 1981 JONC 3 décembre 1981.",
            metaDescription: "Idcc 1090 : Services de l'automobile (Commerce et réparation de l'automobile, du cycle et du motocycle, activités connexes, contrôle technique automobile, formation des conducteurs)",
            num: 1090,
            ...
            title: "Services de l'automobile (Commerce et réparation de l'automobile, du cycle et du motocycle, activités connexes, contrôle technique automobile, formation des conducteurs)",
            url: "https://www.legifrance.gouv.fr/affichIDCC.do?idConvention=KALICONT000005635191"
        }, versions);
        await writeFile(join(__dirname, "./cdtn_document.data.json"), JSON.stringify(data, 0, 2));
    } catch (error) {
...
//# sourceMappingURL=fetch_mock_data.js.map