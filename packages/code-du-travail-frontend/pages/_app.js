...
export default class MyApp extends App {
  ...
  static async getInitialProps({ Component, ctx }) {
    ...
    // maybe this should be done at the page level to allow static optimization at the __app lvl
    if (ctx.req) {
  ...
  render() {
    ...
    // Maybe that this should be done at the page level to allow static optimization at the __app lvl
