              ...
              <Figcaption>
                <MoreContent noLeftPadding title="Voir en détail">
                  <Wrapper variant="dark">
                    ...
                    <Ul>
                      <Li>
                        Pour faire face aux conséquences économiques,
                        financières et sociales de la propagation du covid-19.
                      </Li>
                      <Li>
                    ...
                    <p>
                      En effet, depuis le 26 mars 2020, l’entreprise peut
                      négocier un accord collectif qui prévoit :
                    </p>
                    <Ol>
                      <Li>
                        <strong>
                        ...
                        il peut s’agir de 6 jours de congés payés acquis
                        maximum.
                      </Li>
                      <Li>
                        <strong>Les congés payés concernés :</strong>{" "}
                        l’employeur peut imposer des jours de congés et/ ou
                        modifier les jours de congés déjà posés.
                      </Li>
                      <Li>
                        <strong>
                      ...
                      <Li>
                        ...
                        l’employeur peut choisir des dates avant l’ouverture de
                        la période au cours de laquelle les congés payés sont
                  ...
                  <Wrapper variant="dark">
                    ...
                    <Ul>
                      <Li>
                        ...
                        maximum, qu’il s’agisse de JRTT, de jours de repos dans
                        le cadre d’un aménagement du temps de travail ou d’un
                        forfait ou du compte épargne-temps.
                      </Li>
                      <Li>
                    ...
                    <p>
                      ...
                      aménagement du temps de travail ou d’un forfait ou le
                      compte épargne-temps (accord collectif, etc.) qui lui
                      seraient contraires.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      et économique), par tout moyen, dès qu’il prend sa
                      décision. Le CSE rend son avis dans le délai d’un mois à
                      compter de cette information. Cet avis peut intervenir
                      après que l’employeur a appliqué sa décision.
                    </p>
                  </Wrapper>
                </MoreContent>
              </Figcaption>
        ...
        content: (
          <>
            ...
            <p>
              ...
              possibilités de dérogation de droit commun continuent à
              s’appliquer. (Dès publication du décret, ce paragraphe sera
              complété.)
            </p>
            ...
            <Ol>
              ...
              <Li>
                <strong>Durée du repos quotidien :</strong> 9 heures
                consécutives (au lieu de 11 heures) par jour, à condition que le
                salarié bénéficie d’un repos compensateur égal à la durée du
                repos supprimée. (Exemple : si le temps de repos est de 10
                heures, le salarié a droit à 1 heure de repos compensateur. Si
                le temps de repos est de 9 heures, le salarié a droit à 2 heures
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <Ol>
              <Li>
                <strong>L’ancienneté d’au moins un an.</strong>
              </Li>
              <Li>
                <strong>
                  Du délai de 48 heures pour justifier de l’incapacité à
                  travailler (maladie ou accident).
                </strong>
              </Li>
              <Li>
                <strong>
                  De soins sur le territoire français ou européen.
                </strong>
              </Li>
            </Ol>
            <p>Peuvent désormais bénéficier des indemnités :</p>
            <Ol>
              <Li>
                <strong>Les salariés travaillant à domicile.</strong>
              </Li>
              <Li>
                <strong>Les salariés saisonniers.</strong>
              </Li>
              <Li>
                <strong>Les salariés intermittents.</strong>
              </Li>
              <Li>
                <strong>Les salariés temporaires.</strong>
              </Li>
            </Ol>
            <p>
        ...
        title: "L’indemnisation des arrêts maladie",
      },
      {
        ...
        content: (
          <>
            <p>
              ...
              Gouvernement a décidé de transformer structurellement le
              dispositif d’activité partielle. Ainsi, les conditions pour
              bénéficier de l’activité partielle, les procédures de demande et
              les modalités de calcul ont été modifiées.
            </p>
            <p>
              Voir les{" "}
          ...
          <>
            ...
            <Ol>
              ...
              <Li>
                ...
                l’intéressement et de la participation sont versées au-delà du
                31 décembre 2020.
              </Li>
            </Ol>
            <ReferencesJuridiques
        ...
        content: (
          <>
            ...
            <Ol>
              ...
              <Li>
                <strong>Le nombre de mineurs de tous âges</strong> placés sous
                la responsabilité exclusive de l’assistant maternel présents
