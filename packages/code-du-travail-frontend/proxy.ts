...
import { BUCKET_URL, URSSAF_API_URL } from "./src/config";
...
export function proxy(request: NextRequest) {
  ...
  const ContentSecurityPolicy = `
    ...
    script-src 'self' 'nonce-${nonce}' https://matomo.fabrique.social.gouv.fr https://tally.so https://www.googletagmanager.com ${
    ...
    base-uri 'self';
    form-action 'self';
    frame-src 'self' https://www.urssaf.fr https://code.travail.gouv.fr https://www.aides-entreprises.fr https://matomo.fabrique.social.gouv.fr https://tally.so https://www.googletagmanager.com *.dailymotion.com https://*.doubleclick.net;
    connect-src 'self' ${URSSAF_API_URL} https://geo.api.gouv.fr https://sentry2.fabrique.social.gouv.fr https://matomo.fabrique.social.gouv.fr https://tally.so https://www.googletagmanager.com https://www.google.com;
