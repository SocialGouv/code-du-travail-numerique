...
export interface Conditions {
	...
	"lg": string
	/** `@media screen and (min-width: 62rem) and (max-width: 77.9975rem)` */
	"lgOnly": string
	/** `@media screen and (max-width: 61.9975rem)` */
	"lgDown": string
	/** `@media screen and (min-width: 78rem)` */
	"xl": string
	/** `@media screen and (min-width: 78rem) and (max-width: 95.9975rem)` */
	"xlOnly": string
	/** `@media screen and (max-width: 77.9975rem)` */
	"xlDown": string
	...
	"smToLg": string
	/** `@media screen and (min-width: 36rem) and (max-width: 77.9975rem)` */
	"smToXl": string
	/** `@media screen and (min-width: 36rem) and (max-width: 95.9975rem)` */
	"smTo2xl": string
	/** `@media screen and (min-width: 48rem) and (max-width: 61.9975rem)` */
	"mdToLg": string
	/** `@media screen and (min-width: 48rem) and (max-width: 77.9975rem)` */
	"mdToXl": string
