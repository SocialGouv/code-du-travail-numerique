...
* **frontend:** disallow web crawlers for dev / staging deployment  ([#1008](https://github.com/SocialGouv/code-du-travail-frontend/issues/1008)) ([a14be3e](https://github.com/SocialGouv/code-du-travail-frontend/commit/a14be3e)), closes [#985](https://github.com/SocialGouv/code-du-travail-frontend/issues/985)
* **frontend:** display error message in ccn infos ([#961](https://github.com/SocialGouv/code-du-travail-frontend/issues/961)) ([0730a0f](https://github.com/SocialGouv/code-du-travail-frontend/commit/0730a0f)), closes [#960](https://github.com/SocialGouv/code-du-travail-frontend/issues/960)
* **frontend:** fix idl anciennete ([#1032](https://github.com/SocialGouv/code-du-travail-frontend/issues/1032)) ([1226cf5](https://github.com/SocialGouv/code-du-travail-frontend/commit/1226cf5)), closes [#1025](https://github.com/SocialGouv/code-du-travail-frontend/issues/1025)
* **frontend:** fix key warning when render modeles list ([#1007](https://github.com/SocialGouv/code-du-travail-frontend/issues/1007)) ([a493342](https://github.com/SocialGouv/code-du-travail-frontend/commit/a493342))
* **frontend:** fix source blur in search ([#958](https://github.com/SocialGouv/code-du-travail-frontend/issues/958)) ([7a1d139](https://github.com/SocialGouv/code-du-travail-frontend/commit/7a1d139))
* **frontend:** fix undefined meta ([#990](https://github.com/SocialGouv/code-du-travail-frontend/issues/990)) ([a417e1e](https://github.com/SocialGouv/code-du-travail-frontend/commit/a417e1e))
* **frontend:** fix wrong link styles ([#1001](https://github.com/SocialGouv/code-du-travail-frontend/issues/1001)) ([85140d1](https://github.com/SocialGouv/code-du-travail-frontend/commit/85140d1))
* **frontend:** handle http error properly for modeles page ([#993](https://github.com/SocialGouv/code-du-travail-frontend/issues/993)) ([8baa5d5](https://github.com/SocialGouv/code-du-travail-frontend/commit/8baa5d5))
* **frontend:** improve CCN explanation text ([#1034](https://github.com/SocialGouv/code-du-travail-frontend/issues/1034)) ([a3e3cab](https://github.com/SocialGouv/code-du-travail-frontend/commit/a3e3cab)), closes [#1011](https://github.com/SocialGouv/code-du-travail-frontend/issues/1011)
* **frontend:** intempestive re-render of form ([#1019](https://github.com/SocialGouv/code-du-travail-frontend/issues/1019)) ([35e4da5](https://github.com/SocialGouv/code-du-travail-frontend/commit/35e4da5))
* **frontend:** make search bar consistent ([#969](https://github.com/SocialGouv/code-du-travail-frontend/issues/969)) ([e202e36](https://github.com/SocialGouv/code-du-travail-frontend/commit/e202e36))
* **frontend:** show age question on ccn 44 ([#950](https://github.com/SocialGouv/code-du-travail-frontend/issues/950)) ([00ff373](https://github.com/SocialGouv/code-du-travail-frontend/commit/00ff373)), closes [#943](https://github.com/SocialGouv/code-du-travail-frontend/issues/943)
* **frontend:** typo in filename ([#1000](https://github.com/SocialGouv/code-du-travail-frontend/issues/1000)) ([923b21d](https://github.com/SocialGouv/code-du-travail-frontend/commit/923b21d))
* **frontend:** update matomo tracking ([#1041](https://github.com/SocialGouv/code-du-travail-frontend/issues/1041)) ([b8c9064](https://github.com/SocialGouv/code-du-travail-frontend/commit/b8c9064))
* **idl:** fix regression [#986](https://github.com/SocialGouv/code-du-travail-frontend/issues/986) + add snapshot ([#989](https://github.com/SocialGouv/code-du-travail-frontend/issues/989)) ([4f99625](https://github.com/SocialGouv/code-du-travail-frontend/commit/4f99625))


### Features

* **frontend:** add ccn 2120 to idl  ([#966](https://github.com/SocialGouv/code-du-travail-frontend/issues/966)) ([cc0bcc2](https://github.com/SocialGouv/code-du-travail-frontend/commit/cc0bcc2)), closes [#931](https://github.com/SocialGouv/code-du-travail-frontend/issues/931)
...
* **frontend:** add simulateur indemnite precarite ([#1023](https://github.com/SocialGouv/code-du-travail-frontend/issues/1023)) ([f6327bc](https://github.com/SocialGouv/code-du-travail-frontend/commit/f6327bc)), closes [#933](https://github.com/SocialGouv/code-du-travail-frontend/issues/933)
* **frontend:** add syntech to calculateur ([#1026](https://github.com/SocialGouv/code-du-travail-frontend/issues/1026)) ([3cfdb0c](https://github.com/SocialGouv/code-du-travail-frontend/commit/3cfdb0c))
* **frontend:** bootstrap sitemap.xml ([#1009](https://github.com/SocialGouv/code-du-travail-frontend/issues/1009)) ([34a3374](https://github.com/SocialGouv/code-du-travail-frontend/commit/34a3374))
* **frontend:** conventions publish date wording update + remove extensions textes ([749c891](https://github.com/SocialGouv/code-du-travail-frontend/commit/749c891))
* **home:** promote outil precarite ([#1046](https://github.com/SocialGouv/code-du-travail-frontend/issues/1046)) ([206bfa0](https://github.com/SocialGouv/code-du-travail-frontend/commit/206bfa0))
* **outil-idl:** exclude some CCNS, fix [#886](https://github.com/SocialGouv/code-du-travail-frontend/issues/886) ([#893](https://github.com/SocialGouv/code-du-travail-frontend/issues/893)) ([89e8c53](https://github.com/SocialGouv/code-du-travail-frontend/commit/89e8c53))


### Reverts

* **frontend:** remove canonical metas ([#1010](https://github.com/SocialGouv/code-du-travail-frontend/issues/1010)) ([623fead](https://github.com/SocialGouv/code-du-travail-frontend/commit/623fead))
