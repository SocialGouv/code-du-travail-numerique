...
const PUBLIC_SENTRY_DSN =
  process.env.NEXT_PUBLIC_SENTRY_DSN || process.env.PUBLIC_SENTRY_DSN || "";
...
nextApp.prepare().then(async () => {
  ...
  - is deployed on prod(${PROD_HOSTNAME}): ${NEXT_PUBLIC_IS_PRODUCTION_DEPLOYMENT}
  - sentry: ${PUBLIC_SENTRY_DSN},
