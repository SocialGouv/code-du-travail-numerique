    ...
    it("should display expected answer", () => {
      expect(screen.queryAllByText(/50 heures par mois/g)[0]).toBeInTheDocument();
          ...
          expect(screen.queryAllByText(/Le salarié peut s'absenter pendant 50 heures par mois, en une ou plusieurs fois en accord avec l'employeur./g)[0]).toBeInTheDocument();
    ...
    it("should display expected answer", () => {
      expect(screen.queryAllByText(/24 heures/g)[0]).toBeInTheDocument();
          expect(screen.queryAllByText(/Le salaire n'est pas maintenu./g)[0]).toBeInTheDocument();
          expect(screen.queryAllByText(/Le salarié peut prendre 2 heures par jour maximum. Si l'employeur et le salarié sont d'accord, les heures d'absence peuvent être cumulées en partie ou en totalité avant la fin du préavis./g)[0]).toBeInTheDocument();
    ...
    it("should display expected answer", () => {
      expect(screen.queryAllByText(/l'équivalent de 30% de l'horaire hebdomadaire inscrit au contrat de travail/g)[0]).toBeInTheDocument();
          expect(screen.queryAllByText(/Le salaire n'est pas maintenu./g)[0]).toBeInTheDocument();
          expect(screen.queryAllByText(/Le salarié peut prendre 2 heures par jour maximum. Si l'employeur et le salarié sont d'accord, les heures d'absence peuvent être cumulées en partie ou en totalité avant la fin du préavis./g)[0]).toBeInTheDocument();
