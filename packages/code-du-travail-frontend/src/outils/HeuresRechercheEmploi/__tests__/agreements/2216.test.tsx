    ...
    it("should display expected answer", () => {
      expect(screen.queryAllByText(/un nombre d'heures égal, chaque mois, à la durée hebdomadaire de travail dans l'établissement/g)[0]).toBeInTheDocument();
          expect(screen.queryAllByText(/Le salaire est maintenu./g)[0]).toBeInTheDocument();
          expect(screen.queryAllByText(/La répartition de ces absences se fera en accord avec la direction. Elles pourront être bloquées à la fin de chaque mois./g)[0]).toBeInTheDocument();
