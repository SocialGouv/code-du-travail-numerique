    ...
    it("should display expected answer", () => {
      expect(screen.queryAllByText(/2 heures par jour/g)[0]).toBeInTheDocument();
          ...
          expect(screen.queryAllByText(/Les heures doivent être prises en accord entre l'employeur et le salarié. Les parties pourront s'entendre pour bloquer tout ou partie de ces heures avant l'expiration du délai de préavis./g)[0]).toBeInTheDocument();
