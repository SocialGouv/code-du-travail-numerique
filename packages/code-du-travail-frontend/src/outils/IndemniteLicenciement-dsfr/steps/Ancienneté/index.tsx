...
} from "../../../CommonIndemniteDepart-dfr/store";
import {
  AbsencePeriods,
...
const StepAnciennete = () => {
  ...
  return (
    <>
      ...
      />
      <h2>Période d’absence prolongée</h2>
      <p>
        Pour rendre la saisie de l&apos;outil plus simple, les absences de moins
        d&apos;un mois ne sont pas comptabilisées. Or, ces absences peuvent
        impacter l&apos;ancienneté et donner ainsi lieu à un montant
