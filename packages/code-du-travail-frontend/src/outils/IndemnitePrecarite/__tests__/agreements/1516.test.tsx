    ...
    it("should display expected answer", () => {
      expect(screen.queryAllByText(/180/g)[0]).toBeInTheDocument();
          expect(screen.queryAllByText(/L'indemnité dite "d'usage"/g)[0]).toBeInTheDocument();
          
        expect(screen.queryAllByText(/article 5 de la convention collective \(point 5.4.3.\)/)[0]).toBeInTheDocument();
