...
const StepContratTravail = (): JSX.Element => {
  ...
  const {
    ...
    showFauteGrave: state.contratTravailConfig.showFauteGrave,
    licenciementFauteGrave:
  ...
  return (
    <>
      <RadioQuestion
        ...
        autoFocus
      />
      {showFauteGrave && typeContratTravail === "cdi" && (
        <RadioQuestion
          questions={[
            {
              label: "Oui",
      ...
      {typeContratTravail === "cdi" && (!showFauteGrave || licenciementFauteGrave === "non") && (
        <RadioQuestion
          questions={[
            {
              label: "Oui",
      ...
      {typeContratTravail === "cdi" &&
        (!showFauteGrave || licenciementFauteGrave === "non") &&
