...
const Hierarchy = () => {
  ...
  return (
    <>
      <Title topStripped>Existe-t-il une hiérarchie entre les textes ?</Title>
      <Container narrow noPadding>
        <p>
          Le principe général en droit du travail est le suivant&nbsp;:
          lorsqu’il existe plusieurs textes sur un même sujet, c’est le texte le
          plus favorable au salarié qui s’applique. Ce principe continue a
                ...
                items={[
                  {
                    ...
                    body: (
                      <>
                        <Heading as="h4">
                          Hiérarchie entre le Code du travail et les conventions
                          ...
                          items={[
                            {
                              ...
                              body: (
                                <>
                                  ...
                                  doivent respecter. Les conventions et accords
                                  collectifs peuvent toutefois prévoir des
                                  mesures plus avantageuses pour le salarié.
                                  Dans ce cas, c’est le texte le plus avantageux
                                  pour le salarié qui s’applique.
                                </>
                              )
                            },
                            {
                              title: (
                                <h5>
                                  ...
                                  prévoir des mesures différentes que celles
                                  ...
                                  <i>
                                    ...
                                    <ul>
                                      <li>
                                        ...
                                        peut prévoir dans une certaine limite un
                                        taux inférieur à 25% (règle prévue par
                                        le Code du travail).
                                      </li>
                                    </ul>
                                  </i>
                                  ...
                                  <i>
                                    ...
                                    <ul>
                                      <li>
                                        ...
                                        supplémentaires. En l’absence d’accord
                                        collectif sur le taux de majoration des
                                        heures supplémentaires s’applique le
                                        code du travail (25% de majoration pour
                                        les 8 premières heures et 50% pour les
                                        suivantes).
                                      </li>
                                    </ul>
                                  </i>
                ...
                items={[
                  {
                    ...
                    body: (
                      <>
                        <Heading as="h4">
                          Hiérarchie entre conventions et accords collectifs de
                          niveaux différents
                        </Heading>
                        <p>
                        ...
                        <p>
                          ...
                          en priorité par rapport à l’accord ou la convention de
                          branche même si, l’accord d’entreprise est plus
                          désavantageux pour le salarié que l’accord de branche.
                        </p>
                        <Toast>
                          ...
                          où la loi reconnaît la primauté à l’accord de branche
                          et{" "}
                          <Button
                            variant="link"
                        ...
                        <p>
                          ...
                          accord de branche et accord de groupe et entre accord
                          de branche et accord d’établissement.
                        </p>
                        <Heading as="h4">
                        ...
                        <p>
                          ...
                          à l’accord d’entreprise ou l’accord d’établissement si
                          l’accord de groupe l’indique dans son accord. Si rien
                          n’est indiqué dans l’accord de groupe alors l’accord
                        ...
                        <p>
                          ...
                          d’entreprise l’indique dans son accord. Si rien n’est
                          indiqué dans l’accord d’entreprise alors l’accord le
                          plus avantageux pour le salarié s’applique.
                        </p>
                      </>
                    )
                  }
                ...
                items={[
                  {
                    ...
                    body: (
                      <>
                        Le règlement intérieur doit respecter les textes situés
