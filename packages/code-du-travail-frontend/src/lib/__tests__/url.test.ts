...
describe("replaceSlug", () => {
  test.each`
    ...
    ${"https://code.travail.gouv.fr/information/pass-sanitaire-et-contrat-de-travail"}                         | ${"https://code.travail.gouv.fr/information/pass-vaccinal-et-contrat-de-travail"}
    ${"https://code.travail.gouv.fr/information/vaccination-et-pass-sanitaire-les-dates-a-retenir"}            | ${"https://code.travail.gouv.fr/information/pass-vaccinal-les-dates-a-retenir"}
  `(
