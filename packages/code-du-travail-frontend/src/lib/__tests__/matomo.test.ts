...
describe("Matomo", () => {
  ...
  describe("Selection de la valeur sur les étapes dynamique", () => {
    test.each`
      ...
      ${"Catégorie professionnelle"} | ${1}      | ${[MatomoBaseEvent.TRACK_EVENT, MatomoBaseEvent.OUTIL, MatomoRetirementEvent.ACTION, MatomoSimulatorEvent.SELECT_CAT_PRO]}
      ${"Ancienneté"}                | ${0}      | ${0}
