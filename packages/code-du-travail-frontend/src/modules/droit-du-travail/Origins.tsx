      ...
      <div className={fr.cx("fr-container", "fr-py-6w")}>
        <div className={fr.cx("fr-grid-row", "fr-col-12", "fr-col-md-8")}>
          ...
          <p className={fr.cx("fr-text--lg")}>
            ...
            dont les sources sont diverses&nbsp;: sources internationales,
            sources européennes et sources nationales. Vous trouverez les textes
        ...
        <div className={fr.cx("fr-grid-row", "fr-grid-row--gutters")}>
          <div className={fr.cx("fr-col-12", "fr-col-md-6")}>
            ...
            >
              ...
              <p>
                ...
                activités syndicales, le travail forcé, l&apos;emploi, le
          ...
          <div className={fr.cx("fr-col-12", "fr-col-md-6")}>
            ...
            >
              ...
              <p>
                L&apos;Union Européenne élabore différents types de
                textes&nbsp;:
              </p>
              <ul>
                <li>des traités</li>
              ...
              <ul>
                <li>
                  ...
                  qui évoque des droits civils et politiques comme par exemple
                  la liberté syndicale, l&apos;interdiction du travail forcé,
                  des discriminations, le respect de la vie privée et familiale.
                </li>
                <li>
                  <Link
          ...
          <div className={fr.cx("fr-col-12", "fr-col-md-6")}>
            ...
            >
              ...
              <p>
                Dans son préambule la Constitution de 1958 renvoie explicitement
                à 3 autres textes fondamentaux&nbsp;:{" "}
                <Link
              ...
              <p>
                ...
                délégués, la liberté syndicale, le droit de grève, le droit à
                une formation professionnelle, le droit d&apos;obtenir un emploi
          ...
          <div className={fr.cx("fr-col-12", "fr-col-md-6")}>
            ...
            >
              ...
              <p>
                ...
                que le Parlement l&apos;y ait autorisé. L&apos;ordonnance a
                valeur de loi lorsque le Parlement l&apos;approuve en votant une
                loi de ratification. Si le Parlement n&apos;approuve pas
                l&apos;ordonnance alors l&apos;ordonnance n&apos;est plus
                applicable.
              </p>
              <p>
                Le décret est un texte adopté par le Président de la République
                ou le Premier ministre. Généralement en droit du travail, les
                décrets viennent préciser une loi.
              </p>
              <p>
                L&apos;essentiel des lois, des ordonnances et des décrets en
                droit du travail se trouve dans le Code du travail. Il existe
                des règles applicables en droit du travail qui se trouvent dans
                d&apos;autres codes que le Code du travail comme par exemple le
                Code civil, le Code de l&apos;action sociale ou le Code de la
                sécurité sociale, le code des transports ou le code rural et de
                la pêche maritime.
              </p>
              <p>
          ...
          <div className={fr.cx("fr-col-12", "fr-col-md-6")}>
            <ExpandableCard
              ...
              id="conventions-accords-collectifs"
            ...
            >
              ...
              <p>
                ...
                d&apos;emploi, de travail et des garanties sociales des
                salariés. L&apos;accord collectif concerne un seul ou quelques
                thèmes des conditions d&apos;emploi, de travail et des garanties
              ...
              <p>
                ...
                professionnelle, au niveau d&apos;un groupe, au niveau
                d&apos;une entreprise ou au niveau d&apos;un établissement.
              </p>
            </ExpandableCard>
          </div>
          ...
          <div className={fr.cx("fr-col-12", "fr-col-md-6")}>
            <ExpandableCard
              ...
              id="usages-engagements-unilateraux"
            ...
            >
              ...
              <p>
                L&apos;engagement unilatéral de l&apos;employeur est un
                engagement écrit de l&apos;employeur d&apos;accorder un avantage
                aux salariés.
              </p>
              <p>
                <strong>
          ...
          <div className={fr.cx("fr-col-12", "fr-col-md-6")}>
            <ExpandableCard
              ...
              id="reglement-interieur-entreprise"
              iconSrc="/static/assets/icons/droit-du-travail/reglement-interieur-entreprise.svg"
              backgroundColor="var(--background-default-grey)"
            >
              <p>
                Le règlement intérieur de l&apos;entreprise est un acte écrit
                par l&apos;employeur qui fixe les règles concernant la
                discipline, la santé et la sécurité dans l&apos;entreprise.
              </p>
            </ExpandableCard>
          </div>
          ...
          <div className={fr.cx("fr-col-12", "fr-col-md-6")}>
            ...
            >
              ...
              <p>
                ...
                durée, l&apos;activité de l&apos;employeur ou la nature du
                travail confié au salarié.
              </p>
            </ExpandableCard>
          </div>
        </div>
        <div
          className={fr.cx("fr-grid-row", "fr-grid-row--center", "fr-mt-4w")}
        >
