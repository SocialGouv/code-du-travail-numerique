...
describe("SimulateurIndemnitePrecarite - IDCC 3127", () => {
  beforeEach(() => {
    render(
  ...
  it("affiche l'indemnité conventionnelle — cas conventionnel : CDD d'usage / CDD de mission ponctuelle ou occasionnelle", () => {
    runJourney({ contractOptionId: "3127-usage-mission-ponctuelle" });
