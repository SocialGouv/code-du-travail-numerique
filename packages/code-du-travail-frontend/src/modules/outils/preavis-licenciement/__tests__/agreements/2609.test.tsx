...
describe("CalculateurPreavisLicenciement", () => {
  ...
  describe("criteria.âge = Moins de 55 ans", () => {
    beforeEach(() => {
      fireEvent.change(
        screen.getByTestId(
          "infos-contrat-salarie-convention-collective-batiment-etam-age"
        ),
        {
    ...
    describe("criteria.ancienneté = Moins de 2 ans", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-batiment-etam-age-Moins-de-55-ans-anciennete"
          ),
          {
  ...
  describe("criteria.âge = Plus de 55 ans", () => {
    ...
    describe("criteria.ancienneté = Au moins 15 ans d'ancienneté", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-batiment-etam-age-Plus-de-55-ans-anciennete"
          ),
          {
