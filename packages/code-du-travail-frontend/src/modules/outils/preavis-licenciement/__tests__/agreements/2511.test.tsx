...
describe("CalculateurPreavisLicenciement", () => {
  ...
  describe("criteria.catégorie professionnelle = Cadres", () => {
    beforeEach(() => {
      fireEvent.change(
        screen.getByTestId(
          "infos-contrat-salarie-convention-collective-sport-categorie-professionnelle"
        ),
        {
          target: { value: "'Cadres'" },
        }
  ...
  describe("criteria.catégorie professionnelle = Non-cadres", () => {
    ...
    describe("criteria.ancienneté = Moins de 2 ans", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-sport-categorie-professionnelle-Noncadres-anciennete"
          ),
          {
