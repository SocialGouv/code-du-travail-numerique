...
describe("CalculateurPreavisLicenciement", () => {
  ...
  describe("criteria.catégorie professionnelle = Agents de maîtrise", () => {
    beforeEach(() => {
      fireEvent.change(
        screen.getByTestId(
          "infos-contrat-salarie-convention-collective-coiffure-categorie-professionnelle"
        ),
        {
  ...
  describe("criteria.catégorie professionnelle = Salariés occupant un emploi de l'esthétique-cosmétique", () => {
    ...
    describe("criteria.ancienneté = 6 mois ou moins", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-coiffure-categorie-professionnelle-Salaries-occupant-un-emploi-de-l'esthetiquecosmetique-anciennete"
          ),
          {
  ...
  describe("criteria.catégorie professionnelle = Salariés occupant un emploi non-technique de la coiffure", () => {
    ...
    describe("criteria.ancienneté = 6 mois ou moins", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-coiffure-categorie-professionnelle-Salaries-occupant-un-emploi-nontechnique-de-la-coiffure-anciennete"
          ),
          {
            target: { value: "'6 mois ou moins'" },
          }
  ...
  describe("criteria.catégorie professionnelle = Salariés occupant un emploi technique de la coiffure", () => {
    ...
    describe("criteria.ancienneté = 6 mois ou moins", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-coiffure-categorie-professionnelle-Salaries-occupant-un-emploi-technique-de-la-coiffure-anciennete"
          ),
          {
            target: { value: "'6 mois ou moins'" },
          }
