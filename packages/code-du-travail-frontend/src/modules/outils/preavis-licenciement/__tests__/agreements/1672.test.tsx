  ...
  describe("criteria.catégorie professionnelle = Cadres", () => {
    ...
    describe("criteria.classe = 5", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-societes-d'assurances-categorie-professionnelle-Cadres-classe"
          ),
          {
            target: { value: "'5'" },
          }
  ...
  describe("criteria.catégorie professionnelle = Non-cadres", () => {
    ...
    describe("criteria.classe = 1", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-societes-d'assurances-categorie-professionnelle-Noncadres-classe"
          ),
          {
            target: { value: "'1'" },
          }
      ...
      describe("criteria.ancienneté = Moins de 2 ans", () => {
        beforeEach(() => {
          fireEvent.change(
            screen.getByTestId(
              "infos-contrat-salarie-convention-collective-societes-d'assurances-categorie-professionnelle-Noncadres-classe-1-anciennete"
            ),
            {
    ...
    describe("criteria.classe = 2", () => {
      ...
      describe("criteria.ancienneté = Moins de 2 ans", () => {
        beforeEach(() => {
          fireEvent.change(
            screen.getByTestId(
              "infos-contrat-salarie-convention-collective-societes-d'assurances-categorie-professionnelle-Noncadres-classe-2-anciennete"
            ),
            {
              target: { value: "'Moins de 2 ans'" },
            }
    ...
    describe("criteria.classe = 3", () => {
      ...
      describe("criteria.ancienneté = Moins de 2 ans", () => {
        beforeEach(() => {
          fireEvent.change(
            screen.getByTestId(
              "infos-contrat-salarie-convention-collective-societes-d'assurances-categorie-professionnelle-Noncadres-classe-3-anciennete"
            ),
            {
              target: { value: "'Moins de 2 ans'" },
            }
    ...
    describe("criteria.classe = 4", () => {
      ...
      describe("criteria.ancienneté = Moins de 2 ans", () => {
        beforeEach(() => {
          fireEvent.change(
            screen.getByTestId(
              "infos-contrat-salarie-convention-collective-societes-d'assurances-categorie-professionnelle-Noncadres-classe-4-anciennete"
            ),
            {
              target: { value: "'Moins de 2 ans'" },
            }
