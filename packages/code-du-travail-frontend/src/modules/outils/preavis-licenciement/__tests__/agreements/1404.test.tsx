...
describe("CalculateurPreavisLicenciement", () => {
  ...
  describe("criteria.catégorie professionnelle = Cadres", () => {
    beforeEach(() => {
      fireEvent.change(
        screen.getByTestId(
          "infos-contrat-salarie-convention-collective-sedima-categorie-professionnelle"
        ),
        {
          target: { value: "'Cadres'" },
        }
    ...
    describe("criteria.niveau = VII et plus", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-sedima-categorie-professionnelle-Cadres-niveau"
          ),
          {
  ...
  describe("criteria.catégorie professionnelle = Ouvriers, Employés", () => {
    ...
    describe("criteria.niveau = I", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-sedima-categorie-professionnelle-Ouvriers,-Employes-niveau"
          ),
          {
            target: { value: "'I'" },
          }
      ...
      describe("criteria.ancienneté = Moins de 2 ans", () => {
        beforeEach(() => {
          fireEvent.change(
            screen.getByTestId(
              "infos-contrat-salarie-convention-collective-sedima-categorie-professionnelle-Ouvriers,-Employes-niveau-I-anciennete"
            ),
            {
    ...
    describe("criteria.niveau = II", () => {
      ...
      describe("criteria.ancienneté = Moins de 2 ans", () => {
        beforeEach(() => {
          fireEvent.change(
            screen.getByTestId(
              "infos-contrat-salarie-convention-collective-sedima-categorie-professionnelle-Ouvriers,-Employes-niveau-II-anciennete"
            ),
            {
              target: { value: "'Moins de 2 ans'" },
            }
  ...
  describe("criteria.catégorie professionnelle = Techniciens et agents de maîtrise TAM", () => {
    ...
    describe("criteria.niveau = IV", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-sedima-categorie-professionnelle-Techniciens-et-agents-de-maitrise-TAM-niveau"
          ),
          {
            target: { value: "'IV'" },
          }
