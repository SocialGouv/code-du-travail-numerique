  ...
  describe("criteria.catégorie professionnelle = Ouvriers, Employés", () => {
    ...
    describe("criteria.motif de rupture = Autre motif hors faute grave ou lourde", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-commerces-de-gros-categorie-professionnelle-Ouvriers,-Employes-motif-de-rupture"
          ),
          {
      ...
      describe("criteria.ancienneté = 2 ans ou moins", () => {
        beforeEach(() => {
          fireEvent.change(
            screen.getByTestId(
              "infos-contrat-salarie-convention-collective-commerces-de-gros-categorie-professionnelle-Ouvriers,-Employes-motif-de-rupture-Autre-motif-hors-faute-grave-ou-lourde-anciennete"
            ),
            {
