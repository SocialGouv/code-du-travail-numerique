  ...
  describe("criteria.catégorie professionnelle = 'Employés'", () => {
    ...
    describe("criteria.ancienneté = 'Moins de 6 mois'", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-restauration-rapide-categorie-professionnelle-Employes-anciennete"
          ),
          {
  ...
  describe("criteria.catégorie professionnelle = 'Ouvriers'", () => {
    ...
    describe("criteria.ancienneté = 'Moins de 6 mois'", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-restauration-rapide-categorie-professionnelle-Ouvriers-anciennete"
          ),
          {
            target: { value: "'Moins de 6 mois'" },
          }
