...
describe("PreavisDemissionSimulator", () => {
  ...
  describe("criteria.logement = 1| Non-logé", () => {
    beforeEach(() => {
      fireEvent.change(
        screen.getByTestId(
          "infos-contrat-salarie-convention-collective-gardien-concierge-logement"
        ),
        {
    ...
    describe("criteria.coefficient = 21| Inférieur ou égal à 602", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-gardien-concierge-logement-Non-loge-coefficient"
          ),
          {
