...
describe("PreavisDemissionSimulator", () => {
  ...
  describe("criteria.catégorie professionnelle = 'Ouvriers'", () => {
    beforeEach(() => {
      fireEvent.change(
        screen.getByTestId(
          "infos.contrat salarié - convention collective - batiment ouvriers employés - catégorie professionnelle"
        ),
        {
    ...
    describe("criteria.ancienneté = 'Au delà de la période d'essai et jusqu'à 3 mois'", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos.contrat salarié - convention collective - batiment ouvriers employés - catégorie professionnelle Ouvriers - ancienneté"
          ),
          {
            target: {
