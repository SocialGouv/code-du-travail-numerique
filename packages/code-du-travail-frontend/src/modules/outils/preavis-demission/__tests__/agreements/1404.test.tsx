  ...
  describe("criteria.catégorie professionnelle = 10| Ouvriers, Employés (niveau III)", () => {
    ...
    describe("criteria.niveau = 4| III", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-sedima-categorie-professionnelle-Ouvriers,-Employes-niveau-III-niveau"
          ),
          {
            target: { value: "'III'" },
          }
  ...
  describe("criteria.catégorie professionnelle = 7| Ouvriers, Employés (niveaux I et II)", () => {
    ...
    describe("criteria.niveau = 2| I à II", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-sedima-categorie-professionnelle-Ouvriers,-Employes-niveaux-I-et-II-niveau"
          ),
          {
            target: { value: "'I à II'" },
          }
