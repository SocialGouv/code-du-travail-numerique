...
describe("HeuresRechercheEmploi", () => {
  ...
  describe("typeRupture = 1| Démission", () => {
    beforeEach(() => {
      fireEvent.change(
        screen.getByTestId(
          "infos-contrat-salarie-convention-collective-restauration-collectivites-typeRupture"
        ),
        {
  ...
  describe("typeRupture = 3| Licenciement", () => {
    ...
    it("should display expected answer", () => {
      ...
      expect(
        screen.queryAllByText(
          /Les heures doivent être prises en accord entre l'employeur et le salarié. Les parties pourront s'entendre pour bloquer tout ou partie de ces heures avant l'expiration du délai de préavis./g
        )[0]
      ).toBeInTheDocument();
