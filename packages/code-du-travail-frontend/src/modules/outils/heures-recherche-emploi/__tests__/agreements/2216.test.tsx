...
describe("HeuresRechercheEmploi", () => {
  ...
  describe("typeRupture = 1| Démission", () => {
    beforeEach(() => {
      fireEvent.change(
        screen.getByTestId(
          "infos-contrat-salarie-convention-collective-commerce-gros-et-detail-alimentation-typeRupture"
        ),
        {
    ...
    describe("criteria.catégorie professionnelle = 48| Cadres", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-commerce-gros-et-detail-alimentation-typeRupture-Demission-categorie-professionnelle"
          ),
          {
            target: { value: "'Cadres'" },
          }
  ...
  describe("typeRupture = 3| Licenciement", () => {
    ...
    describe("criteria.catégorie professionnelle = 48| Cadres", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-commerce-gros-et-detail-alimentation-typeRupture-Licenciement-categorie-professionnelle"
          ),
          {
            target: { value: "'Cadres'" },
          }
