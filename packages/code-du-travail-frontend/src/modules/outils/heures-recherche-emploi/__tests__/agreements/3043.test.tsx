...
describe("HeuresRechercheEmploi", () => {
  ...
  describe("typeRupture = 1| Démission", () => {
    beforeEach(() => {
      fireEvent.change(screen.getByTestId("infos.contrat salarié - convention collective - entreprises propreté - typeRupture"), {
    ...
    it("should display expected answer", () => {
      ...
      expect(
        screen.queryAllByText(
          /Les heures peuvent être groupées en fin de préavis par accord entre l'employeur et le salarié, ou prises chaque jour une fois au choix du salarié, une fois au choix de l'employeur./g
        )[0]
      ).toBeInTheDocument();
