...
describe("HeuresRechercheEmploi", () => {
  ...
  describe("typeRupture = 1| Démission", () => {
    beforeEach(() => {
      fireEvent.change(
        screen.getByTestId(
          "infos-contrat-salarie-convention-collective-bureaux-etudes-techniques-typeRupture"
        ),
        {
  ...
  describe("typeRupture = 7| Rupture de la période d'essai", () => {
    ...
    describe("criteria.initiative de la rupture de la période d'essai = 1| L'employeur", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-bureaux-etudes-techniques-typeRupture-Rupture-de-la-periode-d'essai-initiative-de-la-rupture-de-la-periode-d'essai"
          ),
          {
