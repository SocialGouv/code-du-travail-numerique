...
describe("HeuresRechercheEmploi", () => {
  ...
  describe("typeRupture = 1| Démission", () => {
    beforeEach(() => {
      fireEvent.change(screen.getByTestId("infos.contrat salarié - convention collective - industrie pharmaceutique - typeRupture"), {
    ...
    it("should display expected answer", () => {
      expect(
        screen.queryAllByText(
          /2 heures par jour en cas de démission légitime donnant droit à l'allocation chômage/g
        )[0]
      ).toBeInTheDocument();
      expect(
      ...
      expect(
        screen.queryAllByText(
          /Les heures sont fixées un jour par le salarié, un jour par l'employeur. Si le salarié demande que ces heures se cumulent en fin de préavis, l'employeur devra accepter./g
        )[0]
      ).toBeInTheDocument();
