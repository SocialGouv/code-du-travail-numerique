...
describe("HeuresRechercheEmploi", () => {
  ...
  describe("typeRupture = 3| Licenciement", () => {
    beforeEach(() => {
      fireEvent.change(
        screen.getByTestId(
          "infos-contrat-salarie-convention-collective-transport-aerien-personnel-au-sol-typeRupture"
        ),
        {
    ...
    describe("criteria.catégorie professionnelle = 23| Agents de maîtrise", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-transport-aerien-personnel-au-sol-typeRupture-Licenciement-categorie-professionnelle"
          ),
          {
  ...
  describe("typeRupture = 1| Démission", () => {
    ...
    describe("criteria.catégorie professionnelle = 23| Agents de maîtrise", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-transport-aerien-personnel-au-sol-typeRupture-Demission-categorie-professionnelle"
          ),
          {
            target: { value: "'Agents de maîtrise'" },
          }
