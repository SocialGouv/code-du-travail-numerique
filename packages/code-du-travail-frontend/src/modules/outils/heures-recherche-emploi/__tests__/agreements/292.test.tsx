...
describe("HeuresRechercheEmploi", () => {
  ...
  describe("typeRupture = 1| Démission", () => {
    beforeEach(() => {
      fireEvent.change(
        screen.getByTestId(
          "infos-contrat-salarie-convention-collective-plasturgie-typeRupture"
        ),
        {
    ...
    describe("criteria.catégorie professionnelle = 48| Cadres", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-plasturgie-typeRupture-Demission-categorie-professionnelle"
          ),
          {
            target: { value: "'Cadres'" },
          }
  ...
  describe("typeRupture = 3| Licenciement", () => {
    ...
    describe("criteria.catégorie professionnelle = 48| Cadres", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-plasturgie-typeRupture-Licenciement-categorie-professionnelle"
          ),
          {
            target: { value: "'Cadres'" },
          }
