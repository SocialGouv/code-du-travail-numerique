...
describe("HeuresRechercheEmploi", () => {
  ...
  describe("typeRupture = 1| Démission", () => {
    beforeEach(() => {
      fireEvent.change(
        screen.getByTestId(
          "infos-contrat-salarie-convention-collective-habillement-textiles-commerce-de-detail-typeRupture"
        ),
        {
    ...
    describe("criteria.catégorie professionnelle = 47| Agents de maîtrise et Cadres", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-habillement-textiles-commerce-de-detail-typeRupture-Demission-categorie-professionnelle"
          ),
          {
      ...
      describe("criteria.durée du travail = 1| Temps complet", () => {
        beforeEach(() => {
          fireEvent.change(
            screen.getByTestId(
              "infos-contrat-salarie-convention-collective-habillement-textiles-commerce-de-detail-typeRupture-Demission-categorie-professionnelle-Agents-de-maitrise-et-Cadres-duree-du-travail"
            ),
            {
    ...
    describe("criteria.catégorie professionnelle = 16| Employés", () => {
      ...
      describe("criteria.durée du travail = 2| Temps partiel", () => {
        beforeEach(() => {
          fireEvent.change(
            screen.getByTestId(
              "infos-contrat-salarie-convention-collective-habillement-textiles-commerce-de-detail-typeRupture-Demission-categorie-professionnelle-Employes-duree-du-travail"
            ),
            {
              target: { value: "'Temps partiel'" },
            }
  ...
  describe("typeRupture = 3| Licenciement", () => {
    ...
    describe("criteria.catégorie professionnelle = 47| Agents de maîtrise et Cadres", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-habillement-textiles-commerce-de-detail-typeRupture-Licenciement-categorie-professionnelle"
          ),
          {
            target: { value: "'Agents de maîtrise et Cadres'" },
          }
      ...
      describe("criteria.durée du travail = 1| Temps complet", () => {
        beforeEach(() => {
          fireEvent.change(
            screen.getByTestId(
              "infos-contrat-salarie-convention-collective-habillement-textiles-commerce-de-detail-typeRupture-Licenciement-categorie-professionnelle-Agents-de-maitrise-et-Cadres-duree-du-travail"
            ),
            {
              target: { value: "'Temps complet'" },
            }
    ...
    describe("criteria.catégorie professionnelle = 16| Employés", () => {
      ...
      describe("criteria.durée du travail = 1| Temps complet", () => {
        beforeEach(() => {
          fireEvent.change(
            screen.getByTestId(
              "infos-contrat-salarie-convention-collective-habillement-textiles-commerce-de-detail-typeRupture-Licenciement-categorie-professionnelle-Employes-duree-du-travail"
            ),
            {
              target: { value: "'Temps complet'" },
            }
  ...
  describe("typeRupture = 7| Rupture de la période d'essai", () => {
    ...
    describe("criteria.catégorie professionnelle = 47| Agents de maîtrise et Cadres", () => {
      beforeEach(() => {
        fireEvent.change(
          screen.getByTestId(
            "infos-contrat-salarie-convention-collective-habillement-textiles-commerce-de-detail-typeRupture-Rupture-de-la-periode-d'essai-categorie-professionnelle"
          ),
          {
            target: { value: "'Agents de maîtrise et Cadres'" },
          }
      ...
      describe("criteria.durée du travail = 1| Temps complet", () => {
        beforeEach(() => {
          fireEvent.change(
            screen.getByTestId(
              "infos-contrat-salarie-convention-collective-habillement-textiles-commerce-de-detail-typeRupture-Rupture-de-la-periode-d'essai-categorie-professionnelle-Agents-de-maitrise-et-Cadres-duree-du-travail"
            ),
            {
              target: { value: "'Temps complet'" },
            }
