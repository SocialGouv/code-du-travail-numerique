...
const createAgreementStore: StoreSliceWrapperHeuresRechercheEmploi<
  AgreementStoreSlice,
  InformationsStoreSlice
> = (set, get) => ({
  agreementData: {
    ...initialState,
    publicodes: loadPublicodes<PublicodesSimulator.HEURES_RECHERCHE_EMPLOI>(
              ...
              set(
                produce((state: AgreementStoreSlice) => {
                  state.agreementData.publicodes =
                    loadPublicodes<PublicodesSimulator.HEURES_RECHERCHE_EMPLOI>(
                      PublicodesSimulator.HEURES_RECHERCHE_EMPLOI,
                      idcc
                    );
                })
