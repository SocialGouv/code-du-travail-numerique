...
import { mapToPublicodesSituationForCalculationHeuresRechercheEmploi } from "src/modules/outils/common/publicodes";
...
const createInformationsStore: StoreSliceWrapperHeuresRechercheEmploi<
