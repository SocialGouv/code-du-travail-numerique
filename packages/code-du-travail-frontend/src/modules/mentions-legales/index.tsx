export const MentionsLegales = () => (
  <div>
    ...
    <div className="fr-mt-3w">
      ...
      <p className="fr-mb-2w">Pierre RAMAIN, Directeur Général du Travail</p>
    </div>
    ...
    <div className="fr-mt-3w fr-py-3w fr-background-color--dark">
      <p>
    ...
    <div className="fr-mt-3w">
      ...
      <p>
        ...
        un contenu ou une fonctionnalité du site,{" "}
        <a
