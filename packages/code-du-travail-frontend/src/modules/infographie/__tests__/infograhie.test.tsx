...
describe("infographie", () => {
  ...
  it("InfographiePage rend la page avec les données formatées (pdfFilesizeOctet -> pdf.sizeOctet en string)", async () => {
    const infographic = {
      date: "14/08/2024",
    ...
    ).toHaveProperty("src", "http://localhost/bucket.url/preview/default/ruptureconventionnelle.svg");
  });
});
