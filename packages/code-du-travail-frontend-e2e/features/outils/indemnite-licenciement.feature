...
Alors je vois "permet d’estimer le montant de l’indemnité de licenciement d’un salarié"
...
Alors je vois "mensuel brut a-t-il été le même durant les 12 derniers mois"
Quand je choisis "#hasSameSalary-non"
