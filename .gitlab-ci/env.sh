...
case ${BRANCH_NAME} in
  master)
    ...
    ;;
  *)
    export ENVIRONMENT=dev.factory;
    #
    export API_HOST=api.${BRANCH_HASH}.code-du-travail-numerique.${ENVIRONMENT}.social.gouv.fr;
    export FRONTEND_HOST=${BRANCH_HASH}.code-du-travail-numerique.${ENVIRONMENT}.social.gouv.fr;
    export NLP_HOST=nlp.${BRANCH_HASH}.code-du-travail-numerique.${ENVIRONMENT}.social.gouv.fr;
